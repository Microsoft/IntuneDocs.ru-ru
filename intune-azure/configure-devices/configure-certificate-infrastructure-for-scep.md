---
title: "Настройка инфраструктуры сертификатов для SCEP | Предварительная версия Intune Azure | Документация Майкрософт"
...
---
# <a name="configure-certificate-infrastructure-for-scep-in-intune-azure-preview"></a>Настройка инфраструктуры сертификатов для SCEP в предварительной версии Intune Azure
...
### <a name="a-namebkmkaccountsaaccounts"></a><a name="BKMK_Accounts"></a>Учетные записи

---
title: "Настройка параметров Intune для приложения iOS Класс | Документация Майкрософт"
titleSuffix: Intune Azure preview
description: "Предварительная версия Intune Azure. Сведения о параметрах Intune, с помощью которых можно управлять параметрами приложения Класс на устройствах iOS."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
Используя профиль **образования** iOS в Intune и сведения из этой статьи, вы сможете настроить приложение Класс и устройства, на которых вы будете его использовать.
...
- Приложение [Класс](https://itunes.apple.com/us/app/classroom/id1085319084?mt=8) необходимо установить на устройстве преподавателя. Это можно сделать вручную или используя возможности [управления приложениями Intune](https://docs.microsoft.com/intune-azure/manage-apps/what-is-app-management).
...
### <a name="how-to-import-data-using-sds"></a>Как импортировать данные с помощью SDS

Данные в SDS можно импортировать, используя один из следующих вариантов:
...
- [Основы группового лицензирования в Azure Active Directory](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-licensing-whatis-azure-portal)
...
Профили образования iOS поддерживают только сертификаты PFX. SCEP-сертификаты не поддерживаются.
...
Назначьте профиль устройствам учащихся в группах аудиторий, созданных при синхронизации учебных данных с Azure AD. (Дополнительные сведения см. в статье [Как назначать профили устройств Microsoft Intune](/intune-azure/configure-devices/how-to-assign-device-profiles).)

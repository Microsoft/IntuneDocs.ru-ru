...
- Подписка на Microsoft Intune и доступ к порталу Azure, который в настоящее время предлагается как общедоступная предварительная версия.
...
Эти категории пользователи видят во время регистрации. В зависимости от выбранной пользователем категории регистрируемое устройство добавляется в соответствующую группу устройств. Инструкции по созданию категорий устройств см. в разделе [Сопоставление устройств с группами](https://docs.microsoft.com/intune-azure/enroll-devices/how-to-use-device-group-mapping).
...
1. В колонке **Intune** портала Azure выберите **Управление приложениями**.

2. В колонке **Управление приложениями** выберите **Управление** > **Приложения**. 
...
Вы настроили взаимодействие служб Intune и Datalert друг с другом. Теперь нужно добавить корпоративные платные телефонные линии в консоль Datalert и определить пороговые значения и действия в случае нарушения правил использования сотовой связи или роуминга. 

...
Этот также относится к параметрам приложений, доступных из приложения iOS "Настройки", таких как Почта, Контакты, Календарь, Facebook и Twitter. Это не применяется к приложениям с параметрами учетных записей, которые не настраиваются из других приложений iOS по работе с настройками, например Microsoft Outlook.

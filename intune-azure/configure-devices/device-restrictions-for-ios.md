---
title: "Параметры ограничений для устройств в Intune для iOS | Предварительная версия Intune Azure | Документация Майкрософт"
...
# <a name="ios-device-restriction-settings-in-intune-azure-preview"></a>Параметры ограничений для устройств iOS в предварительной версии Intune Azure

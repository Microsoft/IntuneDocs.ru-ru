---
title: "Параметры VPN Intune для устройств Windows Phone 8.1 | Предварительная версия Intune Azure | Документация Майкрософт"
...
# <a name="vpn-settings-for-windows-phone-81-devices-in-intune-azure-preview"></a>Параметры VPN для устройств Windows Phone 8.1 в предварительной версии Intune Azure

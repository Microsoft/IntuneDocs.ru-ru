...
# <a name="windows-phone-81-device-restriction-settings-in-intune-azure-preview"></a>Параметры ограничений устройств с Windows Phone 8.1 в предварительной версии Intune Azure

---
title: "Параметры VPN Intune для устройств iOS | Предварительная версия Intune Azure | Документация Майкрософт"
...
# <a name="vpn-settings-for-ios-devices-in-intune-azure-preview"></a>Параметры VPN для устройств iOS в предварительной версии Intune Azure

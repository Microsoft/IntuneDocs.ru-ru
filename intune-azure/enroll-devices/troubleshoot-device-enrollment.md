---
title: "Устранение неполадок при регистрации устройств | Предварительная версия Intune Azure | Документация Майкрософт"
...
В колонке Intune портала Azure перейдите к элементу **Регистрация устройств** > **Ограничения регистрации** и убедитесь, что пользователю назначено не более 15 устройств (максимально допустимое количество).

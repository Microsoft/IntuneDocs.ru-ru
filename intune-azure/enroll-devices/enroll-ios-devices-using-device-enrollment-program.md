---
title: "Регистрация устройств iOS — программа регистрации устройств | Предварительная версия Intune Azure | Документация Майкрософт"
...
1. В колонке Intune портала Azure выберите **Регистрация устройств**, а затем щелкните **Регистрация Apple**.

2. В разделе **Управление параметрами для программы регистрации устройств Apple** выберите **Серийные номера из программы регистрации устройств**.

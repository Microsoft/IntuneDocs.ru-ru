...
Необходимо выбрать действие назначения **Обязательно**. Доступные установки сейчас не поддерживаются. Кроме того, назначения для групп устройств доступны для новых клиентов, созданных после января 2017 г. Если клиент был создан до этого срока, и нет возможности назначать приложения VPP группам устройств, обратитесь в службу поддержки Intune.

...
Конечные пользователи могут установить приложение корпоративного портала из магазина Windows для управления устройствами и установки приложений. Тем не менее, если, исходя из потребностей бизнеса, вам требуется развернуть приложение корпоративного портала, вы можете вручную развернуть приложение корпоративного портала для Windows 10 напрямую из Intune, даже если служба Intune еще не интегрирована с Магазином Windows для бизнеса.

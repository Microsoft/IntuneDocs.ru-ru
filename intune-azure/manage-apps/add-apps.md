...
Кроме того, некоторые приложения Microsoft добавляются автоматически с помощью Intune во время настройки вашего клиента. Список этих приложений вы найдете далее в этой статье.

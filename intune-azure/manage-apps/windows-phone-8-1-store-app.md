---
title: "Как добавлять в Intune приложения из магазина Windows Phone 8.1 | Предварительная версия Intune Azure | Документация Майкрософт"
...
# <a name="how-to-add-windows-phone-81-store-apps-to-intune"></a>Как добавлять в Intune приложения из магазина Windows Phone 8.1

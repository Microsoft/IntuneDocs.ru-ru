...
**Если вы не используете предварительную версию Intune в Azure**, в этой статье объясняется, как [создать политики защиты приложения](https://docs.microsoft.com/intune/deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune) в классической консоли Intune.

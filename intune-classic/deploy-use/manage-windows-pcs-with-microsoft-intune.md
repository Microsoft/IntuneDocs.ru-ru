...
-   **[Защита от вредоносных программ](/intune-classic/deploy-use/help-secure-windows-pcs-with-endpoint-protection-for-microsoft-intune)**. В Intune входит компонент Endpoint Protection, который помогает защитить компьютеры от вредоносных программ.
...
Intune управляет компьютерами с Windows с помощью политик по аналогии с доменными службами Windows Server Active Directory /intune-classic/deploy-use/resolve-gpo-and-microsoft-intune-policy-conflicts) в вашей организации. Дополнительные сведения см. в статье [Групповая политика для начинающих](https://technet.microsoft.com/library/hh147307.aspx).

...
После переключения на новый Центр MDM может пройти некоторое время (до восьми часов), прежде чем устройство зарегистрируется в новой службе и синхронизируется с ней. В новом Центре MDM (в гибридной среде) нужно настроить ряд параметров, чтобы зарегистрированные устройства оставались управляемыми и защищенными после переключения. Обратите внимание на следующее.

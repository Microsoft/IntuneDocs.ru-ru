...
>
>Если ссылка на портал Azure AD отсутствует, значит вы все еще используете *текущий* подход к управлению группами, описанный в разделе [Создание групп](#create-groups) этой статьи.

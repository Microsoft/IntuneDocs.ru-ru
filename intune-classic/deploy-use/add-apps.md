...
|----------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|         <strong>Установщик Windows (EXE, MSI)</strong>          | Этот тип приложения должен поддерживать автоматическую установку без участия пользователя. Параметры командной строки для автоматической установки приложения (например, <strong>/q</strong>) должны быть указаны в документации к нему. Список распространенных параметров командной строки можно найти в [параметрах командной строки для установщика Microsoft Windows](https://support.microsoft.com/kb/227091).<br><br>Все дополнительные файлы и папки, необходимые для программы установки приложений, должны быть доступны в расположении, выбранном для файлов установки приложений.<br><br>В большинстве случаев для файлов установщика Windows (MSI) и исправления для установщика Windows (MSP) не требуется устанавливать аргументы командной строки с помощью Intune. Обратитесь к документации по приложению.<br><br>Если аргументы командной строки требуются, они должны указываться в виде пар Имя = Значение (например TRANSFORMS = custom_transform.mst).<br><br>Этот тип приложений подходит только для компьютеров, на которых установлен клиент программного обеспечения Intune. |
|            <strong>Пакет приложения для Android (APK)</strong>            |                                                                                                                                                                                                                                                                                                                                                                                                                                          Для развертывания приложений Android необходим допустимый пакет APK.                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|              <strong>Пакет приложения для iOS (IPA)</strong>              |                                                                                                                                                                            Для развертывания приложений iOS необходимо иметь допустимый пакет IPA.<br><br>Пакет IPA должен быть подписан Apple, а дата окончания срока действия в профиле подготовки должна быть допустимой. Intune может распространять приложения iOS с корпоративным сертификатом.<br><br>Поддерживаются не все приложения с сертификатом разработчика Apple.<br><br>Организация должна быть зарегистрирована как участник программы iOS Developer Enterprise Program.<br><br>Убедитесь, что брандмауэр организации разрешает доступ к веб-сайтам подготовки и сертификации iOS.<br><br>Не нужно развертывать PLIST-файл манифеста с приложением.                                                                                                                                                                             |
| <strong>Пакет приложения Windows Phone (XAP, APPX, APPXBUNDLE)</strong> |                                                                                                                                                                                                                                                                                                                                                                  Для развертывания приложений требуется корпоративный сертификат подписи кода для мобильных устройств. Подробные сведения см. в разделе [Настройка управления Windows Phone с помощью Microsoft Intune](set-up-windows-device-management-with-microsoft-intune.md).                                                                                                                                                                                                                                                                                                                                                                  |
|         <strong>Пакет приложения Windows (APPX, APPXBUNDLE)</strong>          |                                                                                                                                                                                                                                                                                                                                                                 Для развертывания приложений требуется корпоративный сертификат подписи кода для мобильных устройств. Подробные сведения см. в разделе [Настройка управления устройствами Windows с помощью Microsoft Intune](set-up-windows-device-management-with-microsoft-intune.md).                                                                                                                                                                                                                                                                                                                                                                  |
|         <strong>Установщик Windows через MDM (MSI)</strong>         |                                                                                             Это приложение используется для создания и развертывания приложений на основе установщика Windows на зарегистрированных компьютерах с Windows 10. Эти компьютеры управляются с помощью управления мобильными устройствами (MDM).<br /><br />Можно передать только один файл с расширением MSI.<br><br>Код продукта файла и версия продукта используются для обнаружения приложения.<br><br>Перезапуски приложения осуществляются в режиме, установленном по умолчанию. От Intune это не зависит.<br><br>Пакеты MSI на уровне пользователя устанавливаются для одного пользователя.<br><br>Пакеты MSI на уровне компьютера устанавливаются для всех пользователей устройства.<br><br>Пакеты MSI двойного режима в настоящее время устанавливаются только для всех пользователей устройства.<br><br>Поддерживаются все обновления, если коды продукта MSI всех версий совпадают.<br>                                                                                             |

...
- [Обзор требуемых URL-адресов и портов](../get-started/network-bandwidth-use.md)
- [Добавление и проверка доменного имени](../get-started/start-with-a-paid-subscription-to-microsoft-intune-step-2.md)

---
title: Параметры политики MAM для iOS
...
---
#  <a name="ios-mobile-app-protection-policy-settings"></a>Параметры политики для защиты мобильных приложений iOS

> [!IMPORTANT]
> Содержимое на этой странице в основном устарело, так как политики защиты приложений Intune были полностью перенесены на портал Azure. Дополнительные сведения о [политиках защиты приложений Intune для iOS на портале Azure](https://docs.microsoft.com/intune/app-protection-policy-settings-ios).

[!INCLUDE[classic-portal](../includes/classic-portal.md)]

Описываемые в этом разделе параметры политики можно [настроить](create-and-deploy-mobile-app-management-policies-with-microsoft-intune.md) для политики защиты приложений на портале Azure в колонке **Все параметры**.
...
| **Require minimum iOS operating system** (Требовать минимальную версию операционной системы iOS) | Выберите **Да**, чтобы получить минимальную версию операционной системы iOS, необходимую для использования этого приложения. Пользователю будет запрещен доступ, если версия iOS на устройстве не соответствует требованиям. | Нет |
...
| **Require minimum Intune app protection policy SDK version** (Требовать минимальную версию устройства пакета SDK для политики защиты приложений Intune) | Выберите **Да**, чтобы задать минимальную версию пакета SDK для политики защиты приложений Intune для использования в приложении. Пользователю будет запрещен доступ, если версия приложения пакета SDK для политики защиты приложений Intune не соответствует требованиям. <br> <br> Дополнительные сведения о пакете SDK для политики защиты приложений Intune см. в [этой статье](/intune/app-sdk). <br><br> | Нет |

...
|Outlook|Электронная почта, полученная приложением Microsoft Outlook для Android удаляется, но только в том случае, если защитой Outlook управляют политики MAM. В противном случае при отмене регистрации данные Outlook не удаляются.</br>Исключение. Если Exchange размещается локально, сообщения электронной почты не удаляются.|Электронная почта, полученная приложением Microsoft Outlook для Android удаляется, но только в том случае, если защитой Outlook управляют политики MAM. В противном случае при отмене регистрации данные Outlook не удаляются.</br>Исключение. Если Exchange размещается локально, сообщения электронной почты не удаляются.|

...
Чтобы просмотреть оповещения в [консоли администрирования Microsoft Intune](https://manage.microsoft.com), перейдите на вкладку **Оповещения** и выберите нужный тип оповещения.
...
Оповещения Intune остаются активными в течение 30 дней или до наступления одного из следующих событий.

- Проблема, вызвавшая оповещение, разрешена.
- Оповещение закрыто вручную.

Закрытые оповещения можно активировать повторно в течение 30 дней после закрытия. Через 30 дней закрытые и неактивные оповещения удаляются из Intune.

...
|Функция|Подробные сведения|Дополнительные сведения|
|--------------|-----------|--------------------|
|Профили сертификатов|Создает и развертывает профили доверенных сертификатов и протокол SCEP /intune-classic/deploy-use/secure-resource-access-with-certificate-profiles)|

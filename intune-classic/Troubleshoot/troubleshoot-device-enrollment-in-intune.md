...
1.  Перейдите по адресу [http://aka.ms/accessaad](http://aka.ms/accessaad) или выберите **Администратор** &gt; **Azure AD** на портале [https://portal.office.com](https://portal.office.com).

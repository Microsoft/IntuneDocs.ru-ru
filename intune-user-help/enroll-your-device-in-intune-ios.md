...
2. При появлении запроса на получение уведомлений корпоративного портала коснитесь пункта **Разрешить**. Корпоративный портал использует уведомления для создания предупреждений, если, например, необходимо обновить параметры устройства. 
    ...
    ![Снимок экрана главной страницы корпоративного портала, подсказка "Уведомления".](./media/ios-04-cp-enroll-1903.PNG)  

3. На странице **Настройка доступа** выберите **Начать**.  

     ![Снимок экрана в приложении корпоративного портала, экран "Настройка доступа".](./media/ios-05-cp-enroll-1903.PNG)  
...
7. iOS 12.2 и более поздних версий: при появлении запроса на открытие корпоративного портала коснитесь кнопки **Открыть**. На экране **Установка профиля управления** перечислены действия для установки профиля.
    ...
    ![Пример снимка экрана корпоративного портала, экран установки профиля управления.](./media/ios-1904-settings-icon.PNG)  
...
10. Введите пароль устройства. Нажмите кнопку **Установить**.    
    ...
    ![Снимок экрана с приложением "Параметры", экран установки профиля с курсором на кнопке **Установить**.](./media/ios-1904-password-install.PNG)  
...
11. Следующий экран — стандартное предупреждение системы для управления устройствами. Чтобы продолжить установку, коснитесь кнопки **Установить**. Если появится запрос на удаленное управление доверием, коснитесь кнопки **Доверять**.  
    ...
    ![Снимок экрана с приложением "Параметры", окно со стандартным предупреждением системы для управления корневым сертификатом и мобильными устройствами.](./media/ios-15-cp-enroll-1903.PNG)  
...
12. После завершения установки нажмите **Готово**. Чтобы убедиться, что профиль установлен, перейдите к параметрам **Управление профилями и устройствами**. Вы должны увидеть профиль в списке **Управление мобильными устройствами**.   
    ...
    ![Снимок экрана с приложением "Параметры", параметры управления профилями и устройствами, где показан профиль управления.](./media/ios-00-cp-enroll-1903.PNG)  
...
13. Вернитесь к приложению корпоративного портала. Корпоративный портал начинает синхронизацию и настройку устройства. Корпоративный портал может потребовать обновить дополнительные настройки устройства. В этом случае коснитесь кнопки **Продолжить**.  
    ...
    ![Снимок экрана корпоративного портала, экран "Настройка доступа", желтый треугольник рядом с требованием параметра.](./media/ios-12-cp-enroll-1903.PNG)  

14. Вы поймете, что установка завершена, когда все элементы в списке будут показывать зеленый круг. Нажмите **Готово**.   
    
    ![Снимок экрана входа в приложении корпоративного портала, экран "Все готово", все круги зеленые.](./media/ios-13-cp-enroll-1903.PNG)  

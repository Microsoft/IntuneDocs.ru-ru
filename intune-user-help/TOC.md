...
### [Установка приложений из приложения корпоративного портала](install-apps-cpapp-windows.md) 
### [Удаленная блокировка устройства из приложения корпоративного портала](remote-lock-your-device-cp-app.md)   
### [Переименование устройства из приложения корпоративного портала](rename-your-device-cpapp.md) 

...
## <a name="enroll-through-settings-app"></a>Зарегистрировать через приложение "Параметры"  
Если не удается получить доступ к Microsoft Store с устройства Windows Phone или если у вас нет учетной записи Майкрософт, выполните следующие действия.

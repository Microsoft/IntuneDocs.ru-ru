...
6.  На экране **Настройка доступа к ресурсам организации** нажмите **НАЧАТЬ**.
    ...
    ![Экран "Настройка доступа к ресурсам организации"](/intune/media/android_cp_enroll_02_post_1709.png)
...
7. На экране **Benefits of device management** (Преимущества управления устройствами) ознакомьтесь с возможностями, которые доступны при регистрации устройства, а затем выберите **ПРОДОЛЖИТЬ**.

    ![Экран преимуществ управления устройствами](/intune/media/android_cp_enroll_02_post_1709.png)

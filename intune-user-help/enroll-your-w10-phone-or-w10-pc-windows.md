---
title: Регистрация устройства Windows 10 в системе управления Intune | Документы Майкрософт
description: В статье описывается, как зарегистрировать мобильное или настольное устройство Windows 10 в системе управления Intune.
keywords: ''
author: lenewsad
ms.author: lanewsad
manager: dougeby

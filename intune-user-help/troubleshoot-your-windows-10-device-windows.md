...
Если вы уже зарегистрировали устройства, но по-прежнему, не может получить доступ к рабочей или учебной электронной почте и файлам, попробуйте выполните эти действия по устранению неполадок.  
...
2. Выполните одно из следующих действий.
   ...
   - Если вы не видите сведения о соединении, показанном выше, или вы видите его, но некоторые из параметров отсутствует, коснитесь **Connect**. Войдите, используя рабочую или учебную учетную запись, чтобы подключиться.  
...
- Если ваша рабочая или учебная учетная запись в списке, вы подключены.  

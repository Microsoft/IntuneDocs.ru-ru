...
Если выводится сообщение __Не удалось автоматически обнаружить конечную точку управления, соответствующую введенному имени пользователя. Проверьте имя пользователя и повторите попытку. Если вы знаете URL-адрес конечной точки управления, введите его.__ , а затем попробуйте повторно ввести имя пользователя и пароль. Если проблема сохраняется, обратитесь к ИТ-администратору веб-сайта и узнайте, какие данные необходимо указать в поле **Конечная точка управления**. Возможно, этот веб-сайт имеет следующий адрес: **www.название_вашей_организации.onmicrosoft.com**. 

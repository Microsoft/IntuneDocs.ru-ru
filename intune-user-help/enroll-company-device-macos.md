---
title: Регистрация корпоративных устройств macOS в службе управления | Документация Майкрософт
...
ms.locfileid: "43016233"
---
# <a name="get-your-company-owned-macos-device-managed"></a>Настройка управления устройством macOS, принадлежащим компании

Узнайте, как настроить автоматическое управление новым устройством macOS в Intune.

Устройства, принадлежащие компании или учебному заведению, обычно предварительно настраивают перед выдачей. Ваша организация отправляет предварительно настроенные параметры на устройство, когда вы включаете его и впервые выполняете вход. После завершения настройки устройства вы получите доступ к рабочим или учебным ресурсам. 
...
Если у вас есть устройство, принадлежащее компании, возможно, оно приобретено по Программе регистрации устройств Apple (DEP). Некоторые компании покупают большое количество устройств iOS или macOS через Apple DEP. Организации могут настраивать устройства и управлять ими с помощью любого поставщика управления мобильными устройствами, например Intune. Если вы являетесь администратором и хотите больше узнать об DEP, см. раздел [Автоматическая регистрация устройств macOS с помощью Программы регистрации устройств от Apple](https://docs.microsoft.com/intune/device-enrollment-program-enroll-macos).  

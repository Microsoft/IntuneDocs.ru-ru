...
Чтобы пользователи могли войти в систему для использования службы Intune или регистрации своих устройств для управления, им нужно назначить лицензию на вашу подписку Intune с [портала Office 365](http://go.microsoft.com/fwlink/p/?LinkId=698854). После назначения лицензии имена пользователей будут отображаться в консоли администрирования Intune. После этого каждый пользователь сможет зарегистрировать до пяти устройств.
...
2.  Выберите учетную запись, которой требуется назначить лицензию пользователя Intune, и щелкните **Microsoft Intune** в свойствах учетной записи.

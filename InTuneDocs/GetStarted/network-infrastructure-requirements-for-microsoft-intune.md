...
Перед настройкой Microsoft Intune ознакомьтесь с этим разделом и другими требованиями в статье [Предварительные сведения для установки Microsoft Intune](what-to-know-before-you-start-microsoft-intune.md)..
...
## Требования к соединителю Service to Service
Service to Service Connector поддерживает только облачную организацию Exchange. Требования к локальной инфраструктуре отсутствуют.

Для использования этого соединителя должны соблюдаться следующие условия.

-   Наличие подписки Office 365 с клиентом Exchange 2013. Пока клиентом является Exchange 2013, соединитель будет поддерживать Exchange 2010 в той же самой среде.

-   Учетная запись пользователя, используемая для установки локального соединителя, должна иметь права администратора клиента для Intune и права администратора в клиенте Exchange с лицензией на использование Exchange Server 2013.

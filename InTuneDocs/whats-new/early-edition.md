...
### <a name="ability-to-restrict-intune-mobile-device-enrollment"></a>Возможность ограничения на регистрацию мобильных устройств в Intune
...
* Регистрация macOS и Windows 8.1 или более поздней версии в качестве платформ для мобильных устройств может быть заблокирована. 
* Ограничение на регистрацию мобильных устройств не означает ограничение на регистрацию агента ПК. 
* Только для iOS существует один дополнительный параметр для блокировки регистрации персональных устройств. Все новые устройства в Intune помечаются как персональные, если только ИТ-администратор не отметит их как принадлежащие организации, как описано в [этой статье](https://docs.microsoft.com/en-us/intune/deploy-use/manage-corporate-owned-devices).

...
Специалисты компании Apple объявили, что начиная с весны 2017 г. к Application Transport Security (ATS) будут применяться определенные требования. ATS позволяет обеспечить высокий уровень безопасности при передаче данных в приложениях по протоколу HTTPS. Это изменение затрагивает клиентов Intune, использующих приложения корпоративного портала для iOS или macOS. Дополнительные сведения см. в [блоге службы поддержки Intune](https://aka.ms/compportalats).
...
Теперь бизнес-приложения из магазина можно назначить пользователям независимо от того, зарегистрированы их устройства в Intune или нет. Если устройство пользователя не зарегистрировано в Intune, для установки ему требуется перейти на веб-сайт корпоративного портала, а не в приложение корпоративного портала.

...
Приложение корпоративного портала Windows 10 теперь включает индикатор выполнения установки приложения для всех операций установки современных приложений, запускаемых из корпоративного портала. Новые сообщения о состоянии для приложения корпоративного портала для Windows 10 появятся на странице [Обновление элементов пользовательского интерфейса для приложения конечного пользователя Intune](whats-new-in-intune-app-ui.md).

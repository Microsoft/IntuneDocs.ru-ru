...
![Пользователю предлагается указать на экране только адрес электронной почты, без пароля. Под полем для адреса электронной почты указана ссылка "Войти с другого устройства".](./media/cp_ios_aad_signin_from_another_device_after_1704_002.png)

...
-   Вы можете ознакомиться с дополнительными сведениями о [профилях электронной почты](https://docs.microsoft.com/intune/deploy-use/configure-access-to-corporate-email-using-email-profiles-with-microsoft-intune) и поддерживаемых платформах.

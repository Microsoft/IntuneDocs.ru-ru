...
-   Дополнительные сведения о том, [как приобрести Microsoft Intune](https://www.microsoft.com/en-us/cloud-platform/microsoft-intune-pricing).
...
-   Дополнительные сведения о [добавлении и развертывании приложений](https://docs.microsoft.com/en-us/intune/deploy-use/deploy-apps).
...
-   Дополнительные сведения о том, [как зарегистрировать устройства](https://docs.microsoft.com/intune/deploy-use/enroll-devices-in-microsoft-intune).

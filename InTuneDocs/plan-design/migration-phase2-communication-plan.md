...
-   Дополнительные инструкции по регистрации на платформе мобильной ОС см. в статье [Инструкции по использованию Microsoft Intune для пользователей](https://docs.microsoft.com/intune/deploy-use/what-to-tell-your-end-users-about-using-microsoft-intune).

...
Чтобы узнать, что происходит при установке приложения корпоративного портала и регистрации устройства, выберите ссылку, которая соответствует устройству.

- [Windows 10](#windows-10)
- [Windows 8.1 и Windows RT](#windows-8-1-and-windows-rt)
- [Windows Phone 8.1 и Windows Phone 8](#windows-phone-8-1-and-windows-phone-8)
- [Windows 7 и Vista](#windows-7-and-vista)

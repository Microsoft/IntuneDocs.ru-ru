...
Чтобы отключить сбор данных об использовании на устройстве iOS, перейдите на страницу **Параметры**, коснитесь **Корпоративный портал**, а затем отключите параметр **Данные об использовании**.

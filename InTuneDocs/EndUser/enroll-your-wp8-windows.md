...
Чтобы зарегистрировать устройство Windows Phone 8, выполните указанные ниже действия.

1.  На устройстве щелкните **Настройки** &gt; **Корпоративные приложения**.

2.  Нажмите **Добавить учетную запись**, а затем войдите, используя рабочую учетную запись.

3.  После добавления учетной записи вас должны попросить установить приложение или концентратор организации. Установите соответствующий флажок и нажмите кнопку **Готово**.

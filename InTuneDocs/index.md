...
ms.topic: hub-page
title: "Документация по Microsoft Intune | Документация Майкрософт"
description: "Сведения о работе с Microsoft Intune (FIXME)"
...
<div class="container">
    <h1>Документация по Microsoft Intune</h1>
    <ul class="pivots">
        <li>
            <a href="#manage">Управление</a>
            <ul id="manage">
                <li>
                    <a href="#manage-featured">Рекомендуемые статьи</a>
                    <ul id="manage-featured" class="cardsC">
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Популярные статьи</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Рекомендуемые статьи</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Новые статьи</h3>
                            </div>
                        </li>
                        <li>
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune-azure/introduction/what-is-microsoft-intune">Intune в предварительной версии портала Azure</a></h3>
                                            <p>Microsoft Intune переносится на портал Azure. Узнайте, какие изменения будут доступны на новом портале. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/plan-design/introduction">Планирование и проектирование развертывания</a></h3>
                                            <p>Подробное описание разработки плана развертывания, проектирования, адаптации Intune и внедрения в рабочую среду.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/deploy-use/how-to-educate-your-end-users-about-microsoft-intune">Как научить пользователей работать с Microsoft Intune</a></h3>
                                            <p>Узнайте, как научить сотрудников пользоваться безопасным доступом, который предоставляет Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/intune_graph_overview">Работа с Intune в Microsoft Graph</a></h3>
                                            <p>Настройка политик и элементов управления Intune с помощью API-интерфейсов Microsoft Graph.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://docs.microsoft.com/en-us/enterprise-mobility-security/solutions/enterprise-mobility-fasttrack-program">Более 150 лицензий? Используйте преимущества FastTrack</a></h3>
                                            <p>Оценка, исправление, запуск в работу и стимулирование использования ваших служб при поддержке специалистов Майкрософт.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/understand-explore/mam-faq">Часто задаваемые вопросы об MAM и защите приложений</a></h3>
                                            <p>Ответы на некоторые часто задаваемые вопросы об управлении мобильными приложениями в Intune и защите приложений в Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/understand-explore/introduction-to-microsoft-intune">Вся документация по Intune</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-intro">Введение</a>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Сведения о возможностях управления устройствами, приложениями и данными в Intune на мобильных устройствах и компьютерах Windows.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Управление мобильными устройствами в Microsoft Intune</h3>
                                            <p>Оценка управления мобильными устройствами в Microsoft Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/understand-explore/introduction-to-microsoft-intune">Вся вступительная документация</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
               <!-- <li>
                ...
                <li>
                    <a href="#manage-plan">Планирование развертывания</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Определение целей, задач и возможных трудностей</h3>
                                            <p>Определение целей и задач развертывания, а также возможных трудностей.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Определение вариантов использования</h3>
                                            <p>Примеры вариантов использования, которые помогут определить, как будет использоваться ваше развертывание. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Разработка плана внедрения</h3>
                                            <p>Определение организационных групп, для которых будет внедряться Intune, и временных рамок внедрения для каждой группы.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/plan-design/introduction">Вся документация по планированию развертывания</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-howto">Инструкции</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Создание политики условного доступа</h3>
                                            <p>Настройка условного доступа для локального сервера Exchange на основе сведений о соответствии устройств.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Настройка центра MDM</h3>
                                            <p>Сведения о параметрах, доступных при настройке центра управления мобильными устройствами.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Настройка профилей устройств</h3>
                                            <p>Сведения о создании профилей конфигурации устройств в Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Настройка ограничений для устройств</h3>
                                            <p>Сведения о настройке параметров ограничений для устройств в Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Сведения о добавлении, назначении и мониторинге приложений.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Создание и назначение политик защиты приложений</h3>
                                            <p>Сведения о создании и назначении политик защиты приложений.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/deploy-use/overview-of-device-and-app-lifecycles-in-microsoft-intune">Все инструкции</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-troubleshoot">Мониторинг и устранение неполадок</a>
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Сведения об известных проблемах в предварительной версии Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Устранение неполадок, связанных с развертыванием приложений</h3>
                                            <p>Устранение распространенных проблем, возникающих при развертывании приложений.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Устранение неполадок, связанных с регистрацией устройств</h3>
                                            <p>Устранение проблем, возникающих при регистрации устройств.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Устранение неполадок, связанных с профилями устройств</h3>
                                            <p>Устранение проблем, возникающих при создании профилей устройств.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Устранение неполадок, связанных с профилями электронной почты</h3>
                                            <p>Устранение проблем, возникающих при создании профилей электронной почты.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">Вся документация по устранению неполадок</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Обзор пакета SDK для приложений Intune</h3>
                                            <p>Сведения о пакете SDK, с помощью которого в приложении можно настроить политики защиты приложений Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Подробное руководство, которое позволит с помощью Microsoft Intune настроить в приложении функцию управления мобильными приложениями.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>В пакет SDK для приложений Intune входит статическая библиотека, файлы ресурсов, заголовки API, список настроек для отладки и конфигуратор.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Работа с Intune в Microsoft Graph</h3>
                                            <p>Настройка политик и элементов управления Intune с помощью API-интерфейсов Microsoft Graph.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Подготовка бизнес-приложений для MAM</h3>
                                            <p>Настройка в приложениях политик управления мобильными приложениями (MAM) с помощью инструмента упаковки приложений Intune или пакета SDK для приложений Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Нужна вся документация? Она доступна <a href="/intune/understand-explore/introduction-to-microsoft-intune">здесь</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Оставить отзыв об Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Подпишитесь на Microsoft Intune в Twitter</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Задавайте вопросы и получайте ответы прямо на форуме</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Блог Enterprise Mobility + Security</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Оставить отзыв о службе Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Отправить отзыв по документации Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>

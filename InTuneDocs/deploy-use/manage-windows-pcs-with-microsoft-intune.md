...
[Регистрация компьютеров с Windows в качестве мобильных устройств](set-up-windows-device-management-with-microsoft-intune.md) — предпочтительный способ их регистрации в Intune. Но ИТ-администратор также может регистрировать компьютеры с Windows и управлять ими, установив клиентское программное обеспечение Intune, как описано в этом разделе. В клиентском программном обеспечении Intune не поддерживается возможность регистрации в качестве мобильного устройства.

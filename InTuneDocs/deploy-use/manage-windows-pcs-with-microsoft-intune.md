...
Intune управляет компьютерами Windows с помощью политик аналогично объектам групповой политики доменных служб Active Directory (AD DS) Windows Server. Если вы планируете управлять компьютерами, присоединенными к домену Active Directory, с помощью Intune, [убедитесь, не конфликтуют ли политики Intune с объектами групповой политики](https://docs.microsoft.com/intune/deploy-use/resolve-gpo-and-microsoft-intune-policy-conflicts), используемыми в вашей организации. Дополнительные сведения см. в статье [Групповая политика для начинающих](https://technet.microsoft.com/library/hh147307.aspx).

...
|**Отключить пользовательский интерфейс клиента**|Задайте значение **Да**, чтобы скрыть пользовательский интерфейс клиента Microsoft Intune Endpoint Protection от пользователей (для вступления в силу требуется перезагрузка клиентского компьютера).<br /><br />Рекомендуемое значение: **Нет**|

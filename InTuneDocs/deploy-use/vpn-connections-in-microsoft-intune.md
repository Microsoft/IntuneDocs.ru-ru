...
2. Щелкните **Добавить**, чтобы создать правило. Для этого правила существуют два типа соответствия. Для каждого правила можно указать только один из этих типов.
  ...
  - **Домены поиска DNS.** Вы можете использовать полные доменные имена, например *team.corp.contoso.com*, или имена доменов, например *contoso.com* (это будет эквивалентно использованию * *.contoso.com*).

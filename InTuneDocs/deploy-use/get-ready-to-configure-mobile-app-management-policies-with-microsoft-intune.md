...
Портал Azure — это новая консоль администрирования для создания политик MAM. Он поддерживает следующие сценарии MAM:
...
Сейчас настраивать политики MAM можно как в **консоли администратора Intune**, так и на **портале Azure**.  Рекомендуется учесть следующие моменты:
...
* **Бизнес-приложения вашей организации**. Эти приложения нужно подготовить для включения пакета SDK приложений Intune перед применением политик MAM.

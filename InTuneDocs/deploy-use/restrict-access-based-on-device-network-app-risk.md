...
description: "Защита доступа к ресурсам компании на основе рисков, связанных с устройством, сетью и приложениями."
keywords: 
author: NathBarn
ms.author: nathbarn
manager: angrobe
...
# <a name="protect-access-to-company-resource-based-on-device-network-and-application-risk"></a>Защита доступа к ресурсам компании на основе рисков, связанных с устройством, сетью и приложениями

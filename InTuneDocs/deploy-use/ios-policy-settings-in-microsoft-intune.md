...
|**Разрешить общий доступ к фото в iCloud**|Разрешает использовать функцию общего потока фотографий в iOS.|
|**Разрешить использовать медиатеку iCloud**|Разрешает пользователю хранить фотографии в iCloud. При отключении все фотографии, хранящиеся в iCloud, удаляются.|

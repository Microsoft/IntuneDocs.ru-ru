...
- Установка ИТ-администратором:
  - Установка вручную
  - установка с помощью групповой политики;
  - установка, включенная в образ диска.

- Установка клиентского программного обеспечения пользователями вручную.

Клиент программного обеспечения Intune, который ИТ-администратор развертывает для пользователя или который пользователь скачивает сам, содержит минимальное программное обеспечение, необходимое для регистрации компьютера в системе управления Intune. Когда компьютер будет зарегистрирован, клиент программного обеспечения Intune скачает полное клиентское программное обеспечение, требуемое для управления компьютером.
...
Точные сведения, которые пользователи видят на веб-портале, могут отличаться. Это зависит от центра MDM вашей учетной записи, а также платформы и версии пользовательского компьютера.

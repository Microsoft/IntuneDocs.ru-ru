...
>[!IMPORTANT]
>Гарантия обновления мобильных устройств<br>
...
## <a name="securing-your-onpremises-email-and-data-so-it-can-be-safely-accessed-by-mobile-devices"></a>Защита локальной электронной почты и данных для безопасного доступа с мобильных устройств
Большинство стратегий обеспечения мобильности предприятия начинаются с плана по предоставлению сотрудникам безопасного доступа к электронной почте с мобильных устройств через Интернет. Во многих организациях все еще имеются локальные данные и серверы приложений, например Microsoft Exchange, размещенные в корпоративной сети. Intune и Microsoft Enterprise Mobility + Security представляют собой уникальное интегрированное [решение для условного доступа](/intune/deploy-use/restrict-access-to-email-and-o365-services-with-microsoft-intune) к Exchange Server, которое гарантирует, что доступ к электронной почте будет возможен только с устройств, зарегистрированных в Intune. При этом не требуется развертывать дополнительный шлюз на периметре корпоративной сети.
...
## <a name="offer-a-bring-your-own-device-byod-program-to-all-employees"></a>Программа "Принеси свое устройство" (BYOD) для всех сотрудников
...
## <a name="issue-corporateowned-phones-to-your-information-workers"></a>Выдача принадлежащих организации телефонов информационным работникам
...
## <a name="issue-limiteduse-shared-tablets-to-your-task-workers"></a>Выдача сотрудникам общих планшетов для ограниченного использования

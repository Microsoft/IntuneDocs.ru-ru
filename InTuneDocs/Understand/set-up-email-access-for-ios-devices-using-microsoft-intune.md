---
title: "Настройка доступа к электронной почте для устройств iOS | Microsoft Intune"
description: "настройка доступа к электронной почте для устройств iOS с помощью Intune"
keywords: 
author: Staciebarker
manager: arob98
ms.date: 04/28/2016

...
Для создания профилей VPN в Intune можно использовать настраиваемые конфигурации. Чтобы создать настраиваемую конфигурацию, выполните указанные ниже действия.
   ...
   ![Диалоговое окно настраиваемой конфигурации профиля VPN](intune/media/Intune_Add_VPN_URI.png)
...
За сведениями о назначении этих параметров и способах их использования клиентам следует обращаться к документации по поставщику службы конфигурации:

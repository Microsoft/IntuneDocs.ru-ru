...
>-**Samsung KNOX**. Intune обнаружит дубликат учетной записи электронной почты по адресу электронной почты и перезапишет его профилем Intune. Если пользователь изменит конфигурацию этой учетной записи, она будет снова заменена на профиль Intune. Обратите внимание, что это может вызвать некоторую путаницу с точки зрения пользователя, конфигурация учетной записи которого перезаписывается.

>Так как Samsung KNOX не использует имя узла для распознавания профиля, рекомендуем не создавать несколько профилей электронной почты для развертывания с одним и тем же адресом электронной почты на разных узлах, так как в этом случае они будут перезаписывать друг друга.

...
>**Android for Work.** Профиль Intune применяется только для профиля работы устройства и не влияет на профили электронной почты в личном профиле пользователя устройства.

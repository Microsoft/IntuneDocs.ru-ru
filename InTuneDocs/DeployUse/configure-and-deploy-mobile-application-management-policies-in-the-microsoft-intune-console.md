...
Для выбора между средством упаковки приложений и пакетом SDK для приложений Intune обратитесь к статье [Выбор способа подготовки приложений к системе управления мобильными приложениями Microsoft Intune](decide-how-to-prepare-apps-for-mobile-application-management-with-microsoft-intune.md).

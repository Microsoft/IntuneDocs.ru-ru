...
# Общие задачи управления ПК Windows с программным клиентом Intune
...
## Запрос и предоставление удаленной помощи для компьютеров под управлением Windows

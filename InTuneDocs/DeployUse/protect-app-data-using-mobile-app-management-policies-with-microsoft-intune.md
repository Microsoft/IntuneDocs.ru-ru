...
> [!IMPORTANT]
> Можно создавать политики управления мобильными приложениями для мобильных приложений Office, которые подключаются к службам Office 365. Политики MAM не поддерживаются для приложений, подключающихся к локальным службам Exchange и SharePoint.


- **Устройства, которые управляются и регистрируются Microsoft Intune**. Обычно это принадлежащие компании устройства.

...
Дополнительные действия требуются только в случае развертывания корпоративного портала на устройствах.  Шаги 2, 3 и 4 в консоли администрирования можно проигнорировать без каких-либо опасений.

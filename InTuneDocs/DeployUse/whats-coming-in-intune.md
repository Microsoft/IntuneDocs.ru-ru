...
Для устройств под управлением iOS 9.3 или более поздней версии вы сможете использовать список скрытых и отображающихся приложений в политике общей конфигурации в следующих целях:
...
Полный список совместимых с MAM приложений см. на сайте [партнеры по приложениям Microsoft Intune](https://www.microsoft.com/cloud-platform/microsoft-intune-partners).
<!--- TFS 1252335 & 1252336--->

...
# <a name="enroll-corporateowned-device-enrollment-program-ios-devices"></a>Регистрация корпоративных устройств с помощью программы регистрации устройств iOS
...
## <a name="apple-dep-management-for-ios-devices-with-microsoft-intune"></a>Управление Apple DEP для устройств iOS с помощью Microsoft Intune
...
1.  **Начало управления устройствами iOS с помощью Microsoft Intune**</br>
...
3.  **Получение токена программы регистрации устройств**</br>
...
4.  **Добавление токена DEP в службу Intune**</br>

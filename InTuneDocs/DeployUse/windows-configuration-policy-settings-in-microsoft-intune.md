...
title: Параметры политики Windows в Microsoft Intune | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
Используйте **общую политику конфигурации Microsoft Intune**, чтобы настроить параметры для зарегистрированных устройств Windows 8 и Windows 8.1:

...
title: Параметры политики Mac OS X в Microsoft Intune | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
|**Число обязательных сложных символов в пароле**|Указывает число сложных символов, требуемое в пароле (от **0** - **4**).<br /><br />Сложный символ — это такой символ, как "**?**"'|
...
|**Запоминать историю паролей**|Этот параметр запрещает применение ранее использовавшихся паролей. Если он установлен, вы можете также задать параметр **Запретить использование предыдущих паролей**, чтобы указать число ранее использовавшихся паролей, которые запрещено использовать повторно (от **1** - **24**).|
...
> [!TIP]
> Дополнительные сведения об отчетах Intune см. в статье [Использование отчетов в Microsoft Intune](understand-microsoft-intune-operations-by-using-reports.md)..
...
1.  В [консоли администрирования Microsoft Intune](https://manage.microsoft.com) последовательно выберите **Отчеты** &gt; **Отчеты о не соответствующих политике приложениях**..
...
|Имя параметра|Подробные сведения|
    ...
    |**Файл профиля конфигурации**|Щелкните элемент **Импорт**, перейдите к профилю конфигурации, созданному с помощью средства Apple Configurator. **Совет.** Сведения о создании профиля конфигурации см в подразделе [Создание файла профиля конфигурации](#BKMK_Prof) в этом разделе.|

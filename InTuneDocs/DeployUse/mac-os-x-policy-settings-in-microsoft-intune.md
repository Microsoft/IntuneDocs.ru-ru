...
> [!TIP] Дополнительные сведения об отчетах Intune см. в статье [Получение сведений об операциях Microsoft Intune с помощью отчетов](understand-microsoft-intune-operations-by-using-reports.md).

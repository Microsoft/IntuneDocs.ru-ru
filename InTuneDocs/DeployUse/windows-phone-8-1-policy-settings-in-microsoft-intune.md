...
title: Параметры политики Windows Phone 8.1 в Microsoft Intune | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
Используйте **политику конфигурации Windows Phone** Microsoft Intune, чтобы настроить следующие параметры для устройств Windows Phone 8.1:

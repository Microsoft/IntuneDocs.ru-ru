...
6.  Теперь повторите шаги 2 и 3, чтобы создать еще один документ, введите любое предложение, и сохраните его не в рабочем, а в личном расположении, например в **личном хранилище OneDrive**.
...
Для просмотра звуковых и видеофайлов, PDF-файлов и файлов изображений на устройствах Android используется [приложение для управления доступом Microsoft Rights Management](https://play.google.com/store/apps/details?id=com.microsoft.ipviewer).

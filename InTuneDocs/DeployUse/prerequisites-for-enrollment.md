...
|-----------|-------------|  
|**Шаг 1.** [Зависимости регистрации устройств](#step-1-device-enrollment-dependencies)|Проверка настройки имени личного домена и готовности сетевого взаимодействия.|  
|**Шаг 2.** [Задание центра управления устройствами ](#step-2-set-mobile-device-management-authority)|Центр управления мобильными устройствами определяет службу, назначенную вашим устройствам.|
|**Шаг 3.** [Настройка корпоративного портала Intune](#step-3-configure-the-intune-company-portal)|Настройка параметров пользовательского интерфейса для приложения корпоративного портала.|  
|**Шаг 4.** [Назначение лицензий пользователя Intune](#step-4-assign-intune-user-licenses)|Назначение лицензий Intune пользователям, чтобы они могли регистрировать устройства.|
|**Шаг 5.** [Настройка управления устройствами](#step-5-set-up-device-management)|Включение связанных с платформой параметров для управления Windows и iOS. На устройствах Android никакая дополнительная настройка не требуется.|

## Шаг 1. Зависимости регистрации устройств
...
## Шаг 2. Задание центра управления мобильными устройствами
...
## Шаг 3. Настройка корпоративного портала Intune
...
## Шаг 4. Назначение лицензий пользователя Intune
...
## Шаг 5. Настройка управления устройствами

...
|**Шаг 3.** [Настройка корпоративного портала](#step-3-configure-company-portal)|Настройка параметров пользовательского интерфейса для приложения корпоративного портала.|  
|**Шаг 4.** [Назначение лицензий пользователя](#step-4-assign-user-licenses)|Назначение лицензий Intune пользователям, чтобы они могли регистрировать устройства.|
|**Шаг 5.** [Включение регистрации](#step-5-enable-enrollment)|Включение связанных с платформой параметров для управления Windows и iOS. На устройствах Android никакая дополнительная настройка не требуется.|
...
## Шаг 3. Настройка корпоративного портала
...
## Шаг 4. Назначение лицензий пользователя

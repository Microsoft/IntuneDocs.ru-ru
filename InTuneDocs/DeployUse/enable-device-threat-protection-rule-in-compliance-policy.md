...
Перед созданием правила защиты устройства от угроз в политике соответствия рекомендуется [настроить в подписке службу Lookout MTP](set-up-your-subscription-with-lookout-mtp.md), [включить подключение Lookout в Intune](enable-lookout-mtp-connection-in-intune.md) и [настроить приложение Lookout for Work](configure-and-deploy-lookout-for-work-apps.md). Правило соответствия требованиям будет принудительно применяться только после завершения настройки.

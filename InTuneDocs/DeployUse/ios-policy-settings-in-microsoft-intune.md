...
>
> -   Перед настройкой устройства iOS для работы в полноэкранном режиме необходимо использовать [средство Apple Configurator](https://itunes.apple.com/us/app/apple-configurator/id434433123?mt=12) или [программу регистрации устройств (DEP) Apple](ios-device-enrollment-program-in-microsoft-intune), чтобы перевести устройство в защищенный режим. Дополнительные сведения о средстве Apple Configurator см. в документации для разработчиков от Apple.

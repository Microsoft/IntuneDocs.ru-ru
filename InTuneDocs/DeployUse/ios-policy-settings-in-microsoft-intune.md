...
|Имя параметра|Подробные сведения|
|----------------|--------------------|
|**Разрешить изменять настройки доверия для приложений предприятия**||
|**Разрешает установку приложений с помощью лишь конфигурации Apple и iTunes.**||
|**Разрешить автоматическое скачивание приложений**||

...
|Установите Intune в качестве центра управления мобильными устройствами|[Настройка Intune в качестве центра управления мобильными устройствами](get-ready-to-enroll-devices-in-microsoft-intune.md#BKMK_Set_MDM_Authority)|
...
2.  На панели ярлыков рабочей области щелкните **Администрирование**.
...
4.  На странице **Настройка подключения к Exchange** щелкните **Загрузка локального соединителя**.

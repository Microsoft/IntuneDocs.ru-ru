...
В этом разделе описывается процедура создания политики MAM на **портале Azure**. Политика MAM, создаваемая на портале Azure, применима во всех сценариях MAM:
...
3.  Выберите пункт **Добавление политики**.

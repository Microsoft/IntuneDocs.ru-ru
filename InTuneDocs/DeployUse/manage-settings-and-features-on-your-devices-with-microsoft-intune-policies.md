...
title: Управление параметрами и компонентами на устройствах с помощью политик Microsoft Intune | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
- **Политики регистрации корпоративных устройств.** Сведения об этих политиках см. в разделе [Set up iOS and Mac management with Microsoft Intune (Настройка управления iOS и Mac с помощью Microsoft Intune)](set-up-ios-and-mac-management-with-microsoft-intune.md)..
...
Сведения см. в разделе [Разрешение доступа к ресурсам компании с помощью Microsoft Intune](enable-access-to-company-resources-with-microsoft-intune.md)..


Полный список политик Intune см. в статье [Microsoft Intune policy reference (Справочник по политикам Microsoft Intune)](microsoft-intune-policy-reference.md)..
...
2.  Выберите нужную политику, используйте рекомендуемые параметры (если они доступны; эти параметры можно изменить позже) или создайте настраиваемую политику со своими параметрами.
    ...
    > [!TIP]
    > Сведения о выборе правильной политики см. в статье [Microsoft Intune policy reference (Справочник по политикам Microsoft Intune)](microsoft-intune-policy-reference.md)..
...
## Задачи для политик Intune

### Обновление политик на устройстве для обеспечения их актуальности (относится только к ПК Windows с установленным клиентским ПО Intune)

1.  На [консоли администрирования Microsoft Intune](https://manage.microsoft.com/)щелкните **Группы**, а затем выберите группу устройств.

2.  Выберите устройства, на которых требуется обновить политики, а затем щелкните **Удаленные задачи** &gt; **Обновить политики**..

3.  В нижнем правом углу консоли администрирования Intune щелкните элемент **Удаленные задачи**, чтобы проверить состояние задачи.

## Справочные сведения о политиках Intune
...
- Компьютеры под управлением Windows, зарегистрированные как устройства — каждые 24 часа

...
|Имя параметра|Подробные сведения|
|----------------|--------------------|
|**Выберите управляемое приложение, запуск которого будет разрешен, если устройство находится в полноэкранном режиме.**|Щелкните **Обзор**, затем выберите управляемое приложение, которое можно будет запускать, когда устройство находится в полноэкранном режиме (приложения, указываемые в виде ссылок на магазин, в настоящее время не поддерживаются). Другим приложениям не будет разрешено выполняться на устройстве.|

...
|----------------|-|----------------|----------------|
|**Требовать пароль для разблокировки мобильных устройств**|Определяет, запрашивать ли пароль на поддерживаемых устройствах.|Да|Да|
...
|**Окончание срока действия пароля (дней)**|Определяет число дней до смены пароля.|Да|Да|
...
- [Использование настраиваемых политик для разрешения и запрета приложений для устройств Samsung KNOX](custom-policy-to-allow-and-block-samsung-knox-apps.md)

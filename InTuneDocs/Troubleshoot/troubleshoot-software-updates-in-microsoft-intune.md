...
Сведения этого раздела помогут решить проблемы с обновлениями программного обеспечения в Microsoft Intune.
...
В следующей таблице перечислены коды ошибок **агента обновления** Intune. Если какой-либо код ошибки отсутствует в этой таблице, см. статью [Windows Update Agent Result Codes](http://go.microsoft.com/fwlink/?LinkID=221542) (Коды результата агента Центра обновления Windows).

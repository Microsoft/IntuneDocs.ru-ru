...
-   **Устройство Windows, зарегистрированное для MDM**: активируется запланированной задачей в 3:00 по местному времени на устройстве и выполняется каждый день.
...
-   **iOS**: политика обновляется раз в день с произвольным интервалом. Это можно выполнить принудительно, открыв корпоративный портал, выбрав устройство и щелкнув **Синхронизация**.

-   **Android**: политика обновляется раз в день с произвольным интервалом. Это можно выполнить принудительно, открыв корпоративный портал, выбрав устройство и щелкнув **Синхронизация**.
...
1.  Снимите компьютер с учета, как описано в статье [Снятие данных и устройств с управления Microsoft Intune](/intune/deploy-use/retire-devices-from-microsoft-intune-management).

...
В этом разделе описаны возможные причины и способы устранения следующих ошибок и предупреждений, сообщения о которых отображаются в области **Состояние Endpoint Protection** [консоли администрирования Intune](https://manage.microsoft.com).

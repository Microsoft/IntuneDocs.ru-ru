...
1.  Войдите в Intune и посетите [Центр администрирования Office 365](https://portal.office.com/Support/SupportEntry.aspx).

2.  Под заголовком **Создание запроса на обслуживание** выберите категорию проблемы, по которой требуется создать запрос.

    -   Для проблем с выставлением счетов и лицензированием выберите **Сведения о выставлении счетов и продуктах**.
    ...
    > Возможно, для просмотра всех категорий вам потребуется щелкнуть элемент **дополнительно** в нижней части списка.

3.  На странице **Identify the issue** (Описание проблемы) выберите **функцию** и **симптом**, по которым вам требуется помощь. Вам будет предложено указать **Issue summary** (Сводные сведения о проблеме) и **Issue details** (Подробные сведения о проблеме).

4.  На странице **Review suggestions** (Рекомендации) вы найдете ссылки на ресурсы, которые могут помочь устранить проблему самостоятельно.  Если вам не удается решить проблему, можно щелкнуть **Yes, continue** (Да, продолжить) в нижней части страницы, чтобы отправить запрос на обслуживание.

5.  На странице **Add details** (Добавление сведений) введите требуемую информацию. Можно приложить снимки экрана или другие документы, щелкнув **Attach a file** (Вложить файл).

6.  На странице **Confirm and submit** (Подтверждение и отправка) укажите контактную информацию, просмотрите свой запрос и щелкните **Отправить запрос**. После отправки запроса отображается список ваших запросов на обслуживание.

...
2.  Под заголовком **Создание запроса на обслуживание** выберите категорию проблемы, по которой требуется создать запрос.
    ...
    -   Для проблем с выставлением счетов и лицензированием выберите **Billing and product info** (Сведения о выставлении счетов и продуктах).
...
5.  На странице **Add details** (Добавление сведений) введите требуемую информацию. Можно приложить снимки экрана или другие документы, щелкнув элемент **Attach a file** (Вложить файл).

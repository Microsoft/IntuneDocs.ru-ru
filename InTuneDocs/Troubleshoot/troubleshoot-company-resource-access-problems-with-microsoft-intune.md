...
# Устранение неполадок, связанных с доступом к ресурсам компании, с использованием Microsoft Intune
...
## Коды состояния для устройств Windows, управляемых с помощью функции MDM
...
## Доступ к ресурсам компании (распространенные ошибки)
...
|-2016315107|0x87D1791D|21005:учетная запись не является уникальной|

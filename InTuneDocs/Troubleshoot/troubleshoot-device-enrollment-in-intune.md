...
-    [Настройка управления устройствами с Android](/intune/deploy-use/set-up-android-management-with-microsoft-intune) —дополнительные действия не требуются
-    [Настройка управления устройствами с Android for Work](/intune/deploy-use/set-up-android-for-work)
...
Список ошибок регистрации в iOS приведен в документации по устройствам для пользователей в статье [You see errors while trying to enroll your device in Intune](/intune/enduser/using-your-iOS-or-macOS-device-with-intune) (Ошибки при попытке регистрации устройства в Intune).

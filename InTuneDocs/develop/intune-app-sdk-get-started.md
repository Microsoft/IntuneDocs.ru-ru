...
До завершения регистрации и ее подтверждения группой разработчиков Microsoft Intune администраторы Intune не смогут применить политику защиты приложений к прямой ссылке на приложение. Майкрософт также добавит приложение на [страницу партнеров Microsoft Intune](https://www.microsoft.com/en-us/cloud-platform/microsoft-intune-apps). На этой странице будет отображаться значок приложения, указывающий, что оно поддерживает политики защиты приложений.

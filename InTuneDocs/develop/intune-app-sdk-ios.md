...
1. **Вариант 1 (рекомендуется)**. Свяжите `IntuneMAM.framework` со своим проектом. Перетащите библиотеку `IntuneMAM.framework` в список **Linked Frameworks and Libraries** (Связанные платформы и библиотеки) цели проекта.

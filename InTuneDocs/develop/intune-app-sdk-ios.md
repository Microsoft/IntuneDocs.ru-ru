...
> [!NOTE] Вы можете сначала прочесть статью [Руководство по началу работы с пакетом SDK для приложений Intune](intune-app-sdk-get-started.md), в которой описана подготовка к интеграции на каждой поддерживаемой платформе.* 
...
> [!NOTE] Теперь для включения и настройки параметров можно использовать раздел "Параметры" -> "Имя_вашего_приложения" -> "Включить политики тестирования".

...
Но если пользователю просто нужен доступ к корпоративной электронной почте и документам, как это часто бывает в случае с личными устройствами, можно потребовать, чтобы он использовал приложения Office для мобильных устройств (к которым [применены политики вложения данных](/intune/deploy-use/protect-apps-and-data-with-microsoft-intune)), а регистрацию устройства можно не выполнять.  

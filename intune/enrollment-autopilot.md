...
1. В [Intune на портале Azure](https://aka.ms/intuneportal) выберите **Группы** > **Создать группу**.
2. В колонке **Группа**
...
4. В качестве **Режима развертывания** выберите один из двух вариантов.
    - **Под управлением пользователя**: устройства с этим профилем привязаны к пользователю, регистрирующему устройство. Для регистрации устройства нужны учетные данные пользователя.

...
2. В разделе **Добавление устройств Windows AutoPilot** укажите CSV-файл со списком устройств, которые необходимо добавить. Этот файл должен содержать серийные номера, идентификаторы продуктов Windows, хэш-коды оборудования и (необязательно) теги групп устройств.

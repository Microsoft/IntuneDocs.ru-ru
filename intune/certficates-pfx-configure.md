...
*Соединитель сертификатов PFX* [поддерживает автоматические обновления](#requirements), тогда как соединитель сертификатов Intune обновляется вручную.
 
### <a name="april-2-2019"></a>2 апреля 2019 г.
- **Соединитель сертификатов NDES — версия 6.1904.1.0**  
...
- **Соединитель сертификатов PFX — версия 6.1904.0.401**
  > [!NOTE]  

...
13. Чтобы сервер мог управлять сертификатами от имени зарегистрированных устройств и пользователей Intune, сделайте следующее:
...
6. Закройте окно.
7. Вернитесь на портал Azure (**Intune** > **Конфигурация устройства** > **ЦС**). Через несколько секунд отображается зеленая галочка, и **Состояние подключения** станет **Активно**. Сервер соединителя теперь может взаимодействовать с Intune.

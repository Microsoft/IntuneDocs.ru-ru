...
1. На [портале Azure](https://portal.azure.com) выберите **Все службы** > **Intune**. Intune находится в разделе **Мониторинг и управление**.
...
5. В колонке **Создать категорию устройств** введите **имя** новой категории и необязательное **описание**.
...
2. В колонке Intune на портале Azure выберите **Устройства**.

3.  В разделе **Manage** (Управление) щелкните **Все устройства**.

4.  В списке устройств просмотрите столбец **Категория устройств**.
...
4. В колонке **Устройства** в разделе **Управление** выберите **Все устройства**.
5. Выберите нужное устройство из списка, а затем в колонке свойств устройства в разделе **Управление** выберите **Свойства**.

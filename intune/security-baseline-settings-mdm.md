...
Самая последняя базовая версия — **базовый уровень безопасности MDM для обновления пружины 2019 (19H1)** .  
...
> [!NOTE]  
> В июне 2019 Предварительная версия базового уровня безопасности MDM была заменена выпуском шаблона " *базовый уровень безопасности MDM для обновления" пружины 2019 (19H1)* , который доступен для общего доступа (не в предварительной версии). Профили, созданные до выпуска базового плана *безопасности MDM для базовой 2019 обновления (19H1)* , не обновляются в соответствии с параметрами и значениями, которые находятся в базовом плане безопасности MDM для обновления пружины 2019 (19H1).  Хотя вы не можете создавать новые профили на основе шаблона предварительной версии, вы можете изменить и продолжить использовать созданные ранее профили, основанные на шаблоне предварительной версии.   
...
Дополнительные сведения см. в разделе [2.2.2 фв_профиле_типое]( https://docs.microsoft.com/openspecs/windows_protocols/ms-fasp/7704e238-174d-4a5e-b809-5f3787dd8acc) в документации по протоколам Windows.  
...
Шаблон *предварительной версии* шаблона *безопасности MDM для обновления пружины 2019 (19H1)* содержит следующие изменения.

                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune на портале Azure</h3>
                                            <p>Решение Microsoft Intune доступно на портале Azure. Сведения об управлении устройствами и приложениями на новом портале. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Начало работы с Intune</h3>
                                            <p>Основы: создание группы и пользователя Регистрация устройств Назначение политик и приложений</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Мои функции Intune исчезли в Azure. Почему?</h3>
                                            <p>Если вы знакомы с Intune в классической консоли, эта статья поможет найти нужный компонент в Intune в Azure.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Она доступна <a href="/intune/what-is-intune">здесь</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">Вся вступительная документация</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/plan-design/introduction">Вся документация по планированию развертывания</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>См. <a href="/intune/device-enrollment">все инструкции</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Сведения об известных проблемах в Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">Вся документация по устранению неполадок</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Нужна вся документация? Она доступна <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">здесь</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>

...
На этапе адаптации вы внедрите Intune в свою рабочую среду. Этот процесс состоит из установки и настройки Intune и внешних зависимостей (при необходимости) с учетом ваших [требований к вариантам использования](planning-guide-requirements.md), рассмотренных в предыдущих разделах данного руководства.

Следующий раздел содержит обзор процесса внедрения Intune, включающего в себя требования и высокоуровневые задачи.

>[!TIP]
> Дополнительные сведения о процессе внедрения Intune см. в разделе [Дополнительные ресурсы](planning-guide-resources.md).
...
>[!TIP]
> Дополнительные сведения о требованиях к автономной версии Intune см. [здесь](/intune/supported-devices-browsers).
...
-   Дополнительные сведения о том, [как настроить управление устройствами iOS и Mac](/intune-classic/deploy-use/set-up-ios-and-mac-management-with-microsoft-intune).
...
Microsoft Intune поддерживает условный доступ для Exchange Online и локальной организации Exchange, SharePoint Online, Skype для бизнеса Online и Dynamics CRM Online. Для включения соответствующих политик используется рабочая область политики на портале администрирования Intune. Включите и настройте нужные политики условного доступа с учетом [требований и вариантов использования для развертывания Intune](planning-guide-requirements.md).
...
В следующем разделе приведены рекомендации по [тестированию и проверке развертывания Intune](planning-guide-test-validation.md).

...
Ознакомьтесь с [параметрами базовых показателей безопасности Windows](security-baselines.md), поддерживаемыми Microsoft Intune. Базовые показатели Windows по умолчанию представляют рекомендуемую конфигурацию для Windows и могут не соответствовать значениям по умолчанию для других базовых показателей безопасности.  

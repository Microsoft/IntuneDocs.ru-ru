...
- **Не оценено**. Начальное состояние для недавно зарегистрированных устройств. Также для устройств, которым не назначены политики соответствия требованиям и на которых нет триггера для проверки на соответствие.

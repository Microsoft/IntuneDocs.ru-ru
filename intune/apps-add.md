...
| Приложения рабочего профиля Android | Приложение магазина  | Найдите и утвердите приложение в рабочем профиле Android из управляемого Google Play Маркета.  |
...
| Бизнес-приложения Windows | Бизнес-приложение | Выберите **Бизнес-приложение** в качестве типа приложения, щелкните **Файл пакета приложения**, а затем выберите файл установки Windows с расширением **.msi**, **.appx** или **.appxbundle**. |
...
- **Рабочий профиль Android**. Приложения назначаются устройствам с рабочим профилем Android иначе, чем обычным устройствам с Android. Все приложения для рабочих профилей Android устанавливаются из управляемого Google Play Маркета. Для этого нужно войти в магазин, найти нужное приложение и подтвердить его установку. Приложение появится в узле **Лицензированные приложения** на портале Azure, и вы сможете управлять назначением приложения так же, как назначением любого другого приложения.

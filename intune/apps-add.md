...
Чтобы добавить приложение в Microsoft Intune, выберите **Клиентские приложения** > **Приложения** > **Добавить**. Отобразится панель **Добавить приложение**, в которой вы можете выбрать **тип приложения**. 
...
4. В области рабочей нагрузки **Клиентские приложения** перейдите к разделу **Установка** и выберите **Категории приложений**.  
...
Дополнительные сведения об ошибках установки приложений Intune см. в разделе [Ошибки установки приложений](troubleshoot-app-install.md#app-installation-errors).

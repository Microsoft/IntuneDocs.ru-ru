...
| Типы приложений | Установка | Updates |
|---|---|---|
...
| Бизнес-приложения iOS | Бизнес-приложение | Выберите **Бизнес-приложение** в качестве **типа приложения**, щелкните **Файл пакета приложения**, а затем выберите файл установки iOS с расширением **.ipa**.  |
| Бизнес-приложения Windows Phone | Бизнес-приложение | Выберите **Бизнес-приложение** в качестве **типа приложения**, щелкните **Файл пакета приложения**, а затем выберите файл установки iOS с расширением **.xap**.  |
| Бизнес-приложения Windows | Бизнес-приложение | Выберите **Бизнес-приложение** в качестве типа приложения, щелкните **Файл пакета приложения**, а затем выберите файл установки iOS с расширением **.msi**, **.appx** или **.appxbundle**. |
| Встроенные приложения для iOS  | Встроенное приложение | Выберите **Встроенное приложение** в качестве **типа приложения**, а затем выберите встроенное приложение из списка предоставляемых приложений.  |
...
Чтобы добавить приложение в Microsoft Intune, выберите **Мобильные приложения** > **Приложения** > **Добавить**. Отобразится панель **Добавить приложение**, в которой вы можете выбрать **тип приложения**. 

>[!TIP]
> Бизнес-приложение — это приложение, добавляемое из файла установки. Например, чтобы установить бизнес-приложение для iOS, в области **Добавить приложение** необходимо выбрать **Бизнес-приложение** в качестве **типа приложения**. Затем выберите файл пакета приложения (с расширением .ipa). Приложения такого типа, как правило, создаются организацией самостоятельно.
...
Защиту управляемых приложений Intune можно также применять без регистрации. Это позволяет использовать политики защиты от потери данных, не управляя устройствами пользователей. Кроме того, с помощью пакета SDK для приложений и средства упаковки приложений Intune в мобильные и бизнес-приложения можно включить функции управления мобильными приложениями. Дополнительные сведения об этих средствах см. в статье [Обзор пакета SDK для приложений Intune](app-sdk.md).
...
4. В области рабочей нагрузки **Мобильные приложения** в разделе **Установка** выберите **Категории приложений**.  

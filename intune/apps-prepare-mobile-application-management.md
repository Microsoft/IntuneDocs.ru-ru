...
|------|----|----|
|**iOS**|Да, используйте [компонент Xamarin из пакета SDK для приложений Intune](app-sdk-xamarin.md).|Да, используйте [подключаемый модуль Cordova из пакета SDK для приложений Intune](app-sdk-cordova.md).|
|**Android**| Да, используйте [компонент Xamarin из пакета SDK для приложений Intune](app-sdk-xamarin.md).|Да, используйте [подключаемый модуль Cordova из пакета SDK для приложений Intune](app-sdk-cordova.md).|

...
- [Обновление политик защиты приложений](app-protection-policy-delivery.md)
- [Проверка настройки политики защиты приложений](https://docs.microsoft.com/en-us/intune/app-protection-policy-delivery)

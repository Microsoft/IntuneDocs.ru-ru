...
- Пользователь должен быть включен в группу безопасности, на которую распространяется политика защиты приложений. Эта же политика защиты приложений должна распространяться и на определенное используемое приложение. Политики защиты приложений можно создавать и развертывать в консоли Intune на [портале Azure](https://portal.azure.com). Сейчас группы безопасности можно создавать на [портале Office](https://portal.office.com).
...
- У пользователя должна лицензия на пакет ["Office 365 бизнес" или "Office 365 корпоративный"](https://products.office.com/business/compare-more-office-365-for-business-plans), связанная с его учетной записью Azure Active Directory. Подписка должна включать приложения Office на мобильных устройствах и может включать облачную учетную запись хранения с поддержкой [OneDrive для бизнеса](https://onedrive.live.com/about/business/). Лицензии Office 365 можно назначить на [портале Office](https://portal.office.com), следуя этим [инструкциям](https://support.office.com/article/Assign-or-remove-licenses-for-Office-365-for-business-997596b5-4173-4627-b915-36abac6786dc).
...
**Что произойдет, если добавить отпечатки пальца или изображение лица на мое устройство или удалить их из устройства?**
...
## <a name="app-protection-policies---policy-refresh"></a>Обновление политик защиты приложений
- Приложения обращаются в службу политик защиты приложений каждые 30 минут.
- 30-минутный интервал устанавливается таймером.
    - Если приложение активно в течение 30 минут, оно обратится в службу через 30 минут.
    - Если приложение неактивно в течение 30 минут, оно обратится при следующем использовании.
- Если политика не назначена пользователю, обращение происходит каждые восемь часов.
- Если лицензия Intune не назначена, обращение происходит каждые 24 часа.

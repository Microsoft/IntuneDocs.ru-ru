...
* Ваше приложение должно быть предназначено для iOS 9.3.5 или более поздней версии.
...
* Прежде чем обращаться к пользовательскому интерфейсу целевой конфигурации MAM, нужно зарегистрировать приложение с помощью службы Intune MAM. См. дополнительные сведения о [получении политики защиты приложения](#receiving-app-protection-policy).

...
Пакет SDK для приложений Intune в iOS включает в себя статическую библиотеку, файлы ресурсов, заголовки API, PLIST-файл настроек отладки и конфигуратор. Для большинства применяемых политик достаточно, чтобы в мобильные приложения были просто включены файлы ресурсов и статические связи с библиотеками. Расширенные функции приложений Intune применяются через API-интерфейсы.

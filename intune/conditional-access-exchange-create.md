...
<br></br>
- Служба AAD DRS активируется автоматически для клиентов Intune и Office 365. Клиенты, которые уже развернули службу регистрации устройств ADFS, не увидят зарегистрированные устройства в своем локальном Active Directory. **Это не относится к ПК под управлением Windows и к устройствам Windows Phone**.
...
1. Если вы хотите исключить определенные группы пользователей, щелкните **Исключенные группы** и выберите группу пользователей, для которой необходимо отменить регистрацию и соответствие требованиям.

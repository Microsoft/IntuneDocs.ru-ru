...
Создавайте и используйте политики конфигурации приложений в Microsoft Intune, чтобы задать параметры конфигурации для приложения в iOS или Android. Эти параметры конфигурации позволяют настраивать приложение, используя [стандартный отраслевой подход](https://www.appconfig.org/) к настройке и администрированию приложений. Параметры политики конфигурации используются, когда приложение проверяет их значения (как правило, при первом запуске). 

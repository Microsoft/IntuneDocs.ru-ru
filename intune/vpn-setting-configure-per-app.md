...
7. На панели **Добавление группы** для параметра **Тип назначения** выберите **Обязательный**.
6. Выберите группу, определенную ранее, и нажмите **Сделать это приложение обязательным**.

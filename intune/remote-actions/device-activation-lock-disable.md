...
ms.locfileid: "76761205"
---
# <a name="disable-activation-lock-on-supervised-ios-devices-with-intune"></a>Отключение блокировки активации на защищенных устройствах iOS с помощью Intune
...
Действие удаленного устройства **Отключение блокировки активации** в Intune позволяет снять блокировку активации с устройства iOS без Apple ID и пароля. После отключения Блокировка активации на устройстве будет повторно включена при запуске приложения "Найти iPhone". Используйте отключение блокировки активации, только когда у вас есть физический доступ к устройству.

...
1. Войдите в [Intune](https://go.microsoft.com/fwlink/?linkid=2090973), а затем выберите **Безопасность устройств** > **Базовые требования безопасности (предварительная версия)** . Список доступных базовых показателей. 

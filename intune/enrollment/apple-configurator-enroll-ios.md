...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Регистрация устройства** > **Регистрации Apple** > **Конфигуратор Apple** > **Профили** > **Создать**.
...
2. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Регистрация устройства** > **Регистрации Apple** > **Конфигуратор Apple** > **Устройства** > **Добавить**.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Регистрация устройства** > **Регистрации Apple** > **Конфигуратор Apple** > **Устройства** > серийные номера > **Назначить профиль**.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Регистрация устройства** > **Регистрации Apple** > **Конфигуратор Apple** > **Профили** > профиль.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Регистрация устройства** > **Регистрации Apple** > **Конфигуратор Apple** > **Профили** > профиль для экспорта.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Регистрация устройства** > **Регистрации Apple** > **Конфигуратор Apple** > **Профили** > профиль для экспорта > **Экспорт профиля**.

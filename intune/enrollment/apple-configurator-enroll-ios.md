...
ms.locfileid: "74691811"
---
# <a name="set-up-ios-device-enrollment-with-apple-configurator"></a>Настройка регистрации устройств iOS с помощью Apple Configurator
...
- **Прямая регистрация**. Этот процесс не выполняет очистку устройства. Он регистрирует устройство, используя параметры iOS. Этот способ предназначен только для устройств **без сходства пользователей**.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **iOS enrollment** (Регистрация iOS)  > **Конфигуратор Apple** > **Профили** > **Создать**.
...
2. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **iOS enrollment** (Регистрация iOS)  > **Конфигуратор Apple** > **Профили** > **Добавить**.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **iOS enrollment** (Регистрация iOS)  > **Конфигуратор Apple** > **Устройства**, выберите серийные номера и **Назначить профиль**.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **iOS enrollment** (Регистрация iOS)  > **Конфигуратор Apple** > **Профили** и выберите профиль.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **iOS enrollment** (Регистрация iOS)  > **Конфигуратор Apple** > **Профили** и выберите профиль для экспорта.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **iOS enrollment** (Регистрация iOS)  > **Конфигуратор Apple** > **Профили**, выберите профиль для экспорта и **Экспорт профиля**.

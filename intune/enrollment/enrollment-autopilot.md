...
Чтобы увидеть оповещения о неназначенных устройствах, в [Intune на портале Azure](https://aka.ms/intuneportal) выберите **Устройства** > **Обзор** > **Оповещения о регистрации** > **Неназначенные устройства**.  

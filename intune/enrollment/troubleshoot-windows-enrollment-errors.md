...
1. Войдите на [портал Azure](https://portal.azure.com/?Microsoft_Intune=1&Microsoft_Intune_DeviceSettings=true&Microsoft_Intune_Enrollment=true&Microsoft_Intune_Apps=true&Microsoft_Intune_Devices=true#blade/Microsoft_Intune_DeviceSettings/ExtensionLandingBlade/overview).
2. Перейдите в раздел **Регистрация устройства** > **ограничения регистрации**, а затем выберите **ограничения на количество устройств**.    
...
2. Перейдите в раздел **Регистрация устройства** > **ограничения регистрации**, а затем выберите ограничение **по умолчанию** в разделе **ограничения по типу устройства**.    
...
2. Перейдите в **Azure Active Directory** **устройства** >   > **Параметры устройства**.    
...
##### <a name="correct-the-mdm-terms-of-use-url"></a>Исправление URL-адреса условий использования MDM
  ...
  3. Выберите **восстановить URL-адреса MDM по умолчанию**, убедитесь, что для параметра **URL-адрес условий использования MDM** задано значение **https://portal.manage.microsoft.com/TermsofUse.aspx** .    
...
2. Перейдите в раздел **администратор** > **клиентское программное обеспечение**, а затем щелкните **загрузить клиентское программное обеспечение**.    
...
1. Войдите на [портал Azure](https://portal.azure.com/) как администратор.    
2. Выберите **Intune** слева, а затем перейдите к разделу **Регистрация устройства** > **ограничения регистрации**.    
...
- В планировщик задач в разделе **Microsoft** > **Windows** > **Ентерприсемгмт**, результат последнего запуска **расписания, созданного клиентом регистрации для автоматической регистрации в MDM из задачи AAD** , выглядит следующим образом: **событие 76. Автоматическая регистрация MDM: сбой (неизвестный код ошибки Win32:0x8018002b)**       
...
1. Перейдите в **Intune**@no__t — 1**Регистрация устройства** > **регистрация Windows** > **устройств**.

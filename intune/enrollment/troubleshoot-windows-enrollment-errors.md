...
1. Войдите на [портал Azure](https://portal.azure.com/) как администратор.    
2. Выберите **Intune** слева, а затем перейдите к разделу **Регистрация устройств**  > **ограничения регистрации**.    
...
1. Перейдите в **Intune**  >  **Регистрация устройств**  > **регистрации Windows**  > **Devices**.

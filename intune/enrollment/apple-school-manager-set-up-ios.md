...
В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **iOS enrollment** (Регистрация iOS)  > **Токены программы регистрации**, выберите токен в списке и **Устройства** > **Синхронизация**. ![Снимок экрана, где показан узел "Устройства программы регистрации" и ссылка "Синхронизация".](./media/apple-school-manager-set-up-ios/image06.png)
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **iOS enrollment** (Регистрация iOS)  > **Токены программы регистрации** и выберите токен в списке.

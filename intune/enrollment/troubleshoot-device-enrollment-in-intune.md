...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Регистрация устройства** > **Ограничения регистрации** > **Ограничения числа устройств**. Обратите внимание на значение в столбце **Предельное число устройств**.

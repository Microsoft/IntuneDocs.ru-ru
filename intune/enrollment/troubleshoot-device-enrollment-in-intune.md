...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **Ограничения регистрации** > **Ограничения числа устройств**. Обратите внимание на значение в столбце **Предельное число устройств**.

2. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Пользователи** > **Все пользователи** > выберите пользователя > **Устройства**. Запомните число устройств.
...
3. В сценарии, где вы используете Configuration Manager с Intune, убедитесь, что пользователь имеет допустимый идентификатор пользователя облака.
    ...
    4. В верхней части окна выберите **Создать запрос** и выполните следующие запросы:
        ...
        - `select * from [CM_ DBName].[dbo].[User_DISC]`, чтобы просмотреть всех пользователей;

        - для просмотра отдельных пользователей используйте следующий запрос, в котором %testuser1% — это заполнитель для username@domain.com для пользователя, которого вы хотите найти: `select * from [CM_ DBName].[dbo].[User_DISC] where User_Principal_Name0 like '%testuser1%'`.
...
### <a name="enrolled-ios-device-doesnt-appear-in-console-when-using-configuration-manager-with-intune"></a>Зарегистрированное устройство iOS не отображается в консоли при использовании Configuration Manager с Intune
...
1. В [Центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **Регистрация iOS** > **Токены программы регистрации** > имя токена > **Профили** > имя профиля > **Управление** > **Свойства**.
...
1. В [Центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **iOS** > **Регистрация iOS** > **Токены программы регистрации** > имя токена > **Устройства**.
...
1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Устройства** > **Все устройства** > **Столбцы** > **Серийный номер** > **Применить**. 
...
- Если устройство все еще назначено другому пользователю в Intune, бывший владелец не использовал приложение корпоративного портала для удаления или сброса устройства. Для удаления устаревшей записи устройства из Intune сделайте следующее.  
    ...
    1. В [центре администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) войдите, используя учетные данные администратора.
...
## <a name="issues-when-using-configuration-manager-with-intune"></a>Проблемы при использовании Configuration Manager с Intune

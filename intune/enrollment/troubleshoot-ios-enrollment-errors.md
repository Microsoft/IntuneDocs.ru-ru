...
2. Выберите затронутую учетную запись пользователя > **лицензий продуктов** > **изменить**.
...
2. Синхронизация устройств, управляемых DEP. Откройте портал Intune > **администратор** > **Управление мобильными устройствами** > **iOS** > **Программа регистрации устройств** > **Sync Now**. Запрос на синхронизацию будет отправлен в Apple.

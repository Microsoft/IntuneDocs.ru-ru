...
1. Войдите в [Intune](https://go.microsoft.com/fwlink/?linkid=2090973) выберите пункты **Регистрация устройства** > **Идентификаторы корпоративных устройств** > **Добавить** > **Отправить CSV-файл**.

   ![Рабочая область идентификатора корпоративного устройства с выделенной кнопкой "Добавить"](./media/corporate-identifiers-add/add-corp-id.png)
...
1. Войдите в [Intune](https://go.microsoft.com/fwlink/?linkid=2090973) выберите пункты **Регистрация устройства** > **Идентификаторы корпоративных устройств** > **Добавить** > **Ручной ввод**.
...
1. Войдите в [Intune](https://go.microsoft.com/fwlink/?linkid=2090973) выберите пункты **Регистрация устройства** > **Идентификаторы корпоративных устройств**.
...
1. Войдите в [Intune](https://go.microsoft.com/fwlink/?linkid=2090973), перейдите в раздел **Устройства** и выберите устройство.

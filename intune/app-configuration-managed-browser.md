...
Эта процедура позволяет вам настроить домашнюю страницу, которую видят пользователи при запуске защищенного браузера или открытии новой вкладки. При создании конфигурации приложения Microsoft Edge или Managed Browser укажите следующие пары ключей и значений:

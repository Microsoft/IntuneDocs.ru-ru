...
Вы можете использовать Microsoft Edge для корпоративных сценариев на устройствах iOS и Android. Microsoft Edge поддерживает те же сценарии управления, что и Intune Managed Browser, с добавлением улучшений в процесс взаимодействия с конечными пользователями. Доступны следующие корпоративный функции Microsoft Edge, охватываемые политиками Intune. Эти корпоративный функции включают:
...
2. **Интеграция политики защиты приложений Intune** — администраторы теперь могут применять политики защиты приложений для Microsoft Edge, включая контроль вырезания, копирования и вставки, предотвращая создания снимков экрана и гарантируя, что выбранные пользователем ссылки открываются исключительно в других управляемых приложениях.
3. **Интеграция с прокси-сервером приложений Azure** — администраторы могут управлять доступом к приложениям и веб-приложениям SaaS, обеспечивая запуск браузерных приложений только в защищенном браузере Microsoft Edge, независимо от того, подключаются ли пользователи из корпоративной сети или через Интернет. 
4. **Ярлыки для управляемого избранного и домашней страницы** — для более удобного доступа администраторы могут настроить отображение URL-адресов в разделе избранного при работе пользователей в корпоративном контексте. Администраторы могут задать ярлык домашней страницы, который будет отображаться первым при открытии корпоративным пользователем новой страницы или вкладки в Microsoft Edge.
...
1. На портале Intune выберите **Условный доступ** > **Новая политика**. 
...
На Android: 
* Если у пользователя на устройстве есть и Managed Browser, и Microsoft Edge, то откроется Managed Browser. Чтобы убедиться, что открывается Microsoft Edge, а не Managed Browser, установите для параметра конфигурации приложения com.microsoft.intune.useEdge значение true для всех управляемых приложений Intune, которым требуется браузер, управляемый политикой.  
* Откроется Microsoft Edge, если на устройстве установлен только этот браузер и на него нацелена политика.
* Откроется Managed Browser, если на устройстве установлен только этот браузер и на него нацелена политика. 

...
8. Выберите **Тип назначения** для конкретного приложения.
   ...
   - **Available with or without enrollment** (Доступно с регистрацией или без нее). Назначает это приложение группам пользователей, чьи устройства не зарегистрированы в Intune. Приложения из управляемого Google Play не поддерживают этот параметр. Пользователям должна быть назначена лицензия Intune. Дополнительные сведения см. в разделе [Лицензии, включающие в себя Intune](licenses.md).

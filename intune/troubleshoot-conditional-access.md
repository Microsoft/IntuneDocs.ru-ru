...
- Устройства Surface Hub поддерживают условный доступ. Но для правильной оценки необходимо развернуть политику соответствия для групп устройств (не групп пользователей).

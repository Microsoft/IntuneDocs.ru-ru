...
* **Android**
  ...
  * [Получение приложений пользователями Android](/intune-classic/deploy-use/how-your-android-users-get-their-apps)

* **iOS**
  * [Использование устройства с iOS с Intune](/intune-user-help/using-your-ios-or-macos-device-with-intune)
  * [Получение приложений пользователями iOS](/intune-classic/deploy-use/how-your-ios-users-get-their-apps)

* **Windows**
  * [Использование устройства с Windows с Intune](/intune-user-help/using-your-windows-device-with-intune)
  * [Получение приложений пользователями Windows](/intune-classic/deploy-use/how-your-windows-users-get-their-apps)

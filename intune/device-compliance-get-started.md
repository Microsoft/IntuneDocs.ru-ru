...
> [!IMPORTANT]
> При выполнении всех оценок соответствия на устройстве Intune соблюдает расписание связи с устройством. [Дополнительные сведения о расписании связи с устройством](device-profile-troubleshoot.md#how-long-does-it-take-for-mobile-devices-to-get-a-policy-or-apps-after-they-have-been-assigned).
...
- В статьях [Что такое условный доступ?](conditional-access.md) и [Каковы стандартные способы использования условного доступа с помощью Intune?](conditional-access-intune-common-ways-use.md) эта возможность описана по отношению к Intune.
...
- **Отметка устройств без назначенной политики соответствия**. Это свойство имеет два значения:
  ...
  Если устройству не назначена политика соответствия, оно считается несоответствующим. По умолчанию устройства помечены как **Не соответствует**. Если вы используете условный доступ, рекомендуется изменить значение на **Не соответствует**. Если пользователь не соответствует требованиям, потому что ему не назначена политика, на [Корпоративном портале](company-portal-app.md) отображается `No compliance policies have been assigned`.
...
- Просмотрите параметры соответствия для различных платформ устройств:
  ...
  - [Windows 8.1 и Windows Phone 8.1](compliance-policy-create-windows-8-1.md)

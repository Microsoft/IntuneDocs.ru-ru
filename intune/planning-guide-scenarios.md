...
Например, в корпоративном сценарии может потребоваться поддержка платформ iOS и Android Samsung KNOX. Политика BYOD может предусматривать поддержку дополнительных платформ мобильных устройств, таких как Android (не Samsung KNOX) и Windows 10 Mobile. Опираясь на предыдущие примеры, мы сопоставили платформы мобильных устройств с каждым сценарием вариантов использования.

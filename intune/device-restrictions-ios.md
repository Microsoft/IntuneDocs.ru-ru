...
---
# Параметры ограничений для устройств iOS в Microsoft Intune
...
### Как указать URL-адрес для приложений в магазине
...
## Режим одного автономного приложения (только в защищенном режиме)
...
### Справочник по идентификаторам наборов для встроенных приложений iOS
...
### Неотмеченные домены электронной почты
...
### Домены автозаполнения пароля Safari

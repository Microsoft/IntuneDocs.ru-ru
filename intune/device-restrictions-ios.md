...
**Утвержденные приложения.** Содержит приложения, которые пользователям разрешено устанавливать. Пользователям запрещено устанавливать приложения, которых нет в списке. Приложения под управлением Intune автоматически разрешены.

Установка запрещенных приложений пользователями не блокируется, но в этом случае вы получаете уведомление.

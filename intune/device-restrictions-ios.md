...
- **Правила использования передачи данных (только управляемые приложения).** Позволяет определять типы данных, которые могут использовать управляемые приложения в сети сотовой связи. Выберите один из следующих типов.
    - **Блокировать использование передачи данных.** Разрешает блокирование использования передачи данных для параметра **Все управляемые приложения** или **Выбрать конкретные приложения**.
    - **Блокировать использование передачи данных в роуминге.** Разрешает блокирование использования передачи данных в роуминге для параметра **Все управляемые приложения** или **Выбрать конкретные приложения**.

...
- **Снимки экрана**. Выберите **Блокировать**, чтобы запретить на устройстве снимки экрана и захват экрана. В iOS 9.0 и более поздние версии сюда также входит блокировки записи экрана. Если выбрать вариант **Не настроено** (по умолчанию), пользователи смогут захватывать содержимое экрана как изображение или видео.
...
- **Личный хот-Спот**: **блок** приводит к отключению личный хот-спот на устройствах пользователей с каждой синхронизации устройства. Этот параметр может быть несовместимым с предложениями некоторых операторов связи. **Не настроено** (по умолчанию) сохраняет конфигурацию личный хот-спот как пользователь задал значение по умолчанию.

...
2. В профиле выберите **Экспорт профиля**.
  ...
  ![Снимок экрана: экспорт профиля для регистрации с использованием помощника по настройке с выделенным URL-адресом профиля](./media/ios-apple-configurator-expor-sat.png)
...
3. В разделе **Экспорт профиля** выберите **Загрузить профиль**, чтобы загрузить профиль регистрации.
  ...
  ![Снимок экрана: экспорт профиля для регистрации с использованием помощника по настройке с выделенным URL-адресом профиля](./media/ios-apple-configurator-expor-de.png)

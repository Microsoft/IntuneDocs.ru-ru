...
|**Условный доступ**|Отсутствует|Доступно. <br>[Что такое условный доступ?](conditional-access.md)|
|**Массовая регистрация**|Отсутствует|Доступно. <br>[Массовая регистрация для устройств Windows](windows-bulk-enroll.md)|
|**Профили устройств**|Отсутствует|Доступно. <br>[Что такое профили устройств в Microsoft Intune?](device-profiles.md)|
|**Регистрация без агентов**|Отсутствует |Доступно.<br>[Регистрация устройств с Windows](windows-enroll.md)|
...
|**Защита приложений**|Отсутствует|Доступно <br>[Что такое политики защиты приложений?](app-protection-policy.md)|
|**Аттестация работоспособности**|Отсутствует|Доступно.|

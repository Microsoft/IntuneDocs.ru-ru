...
**Добавить** — кнопка для добавления сервера AirPrint в список. Можно добавить несколько серверов AirPrint. Вы также можете **импортировать** CSV-файл с этими данными. **Export** создает список добавленных серверов AirPrint.
...
Эти параметры позволяют управлять доступом к URL-адресу в браузере на защищенных устройствах iOS.

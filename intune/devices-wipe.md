...
description: "Узнайте, как выполнить выборочную очистку корпоративных данных на устройстве или провести полную очистку (восстановление заводских настроек устройства).\""
keywords: 
author: nathbarn
ms.author: nathbarn
manager: angrobe
...
|Outlook|Удаляются сообщения, полученные приложением Microsoft Outlook для Android.</br>Исключение. Если Exchange размещается локально, сообщения электронной почты не удаляются.|Удаляются сообщения, полученные приложением Microsoft Outlook для Android.</br>Исключение. Если Exchange размещается локально, сообщения электронной почты не удаляются.|

...
|Тип данных|iOS|
|-------------|-------|
|Приложения организации и связанные с ними данные, установленные Intune|**Приложения, установленные с помощью корпоративного портала**. В случае приложений, которые прикреплены к профилю управления, все данные приложений и сами приложения будут удалены. К ним относятся приложения, изначально установленные из App Store, но управляемые как корпоративные приложения. <br /><br /> **Microsoft apps that use mobile app management and were installed from App Store** (Приложения Майкрософт, использующие политики управления мобильными приложениями и установленные из App Store): В случае приложений, которые не управляются на корпоративном портале, будут удалены данные приложения компании, защищенные шифрованием управления мобильными приложениями (MAM) в локальном хранилище приложения. Данные, защищенные с помощью шифрования MAM за пределами приложения, остаются зашифрованными и непригодными для использования, но не удаляются. Личные приложения и данные о них не удаляются.|

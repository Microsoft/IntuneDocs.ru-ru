...
Действие **Очистка** восстанавливает на устройстве заводские настройки. Данные пользователей сохраняются, если установлен флажок **Сохранить состояние регистрации и учетную запись пользователя**. В противном случае данные будут надежно удалены с устройства.
...
|Тип данных|iOS|
|-------------|-------|
|Приложения организации и связанные с ними данные, установленные Intune|**Apps installed using Company Portal** (Приложения, установленные с помощью Корпоративного портала): удаляются все приложения и данные о них. К ним относятся приложения, изначально установленные из App Store, но управляемые как корпоративные приложения. <br /><br /> **Microsoft apps that use mobile app management and were installed from App Store** (Приложения Майкрософт, использующие политики управления мобильными приложениями и установленные из App Store): удаляются данные личных приложений. Корпоративные приложения и данные о них не удаляются.|
...
|Отсоединение Azure AD|Нет.|Нет.|Удаляется запись Azure AD.|Неприменимо. В Windows 10 невозможно прекратить использование устройств, присоединенных к Azure AD.|

...
С помощью политик Intune можно отправить уведомление о несоответствии и заблокировать устройство. Когда устройство возвращается на территорию объекта и снова оказывается в сетевом расположении, оно может быть разблокировано и снова получить доступ к корпоративным ресурсам.

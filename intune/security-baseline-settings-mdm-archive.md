---
title: Архивировать - параметров базовых показателей безопасности Intune MDM для Windows 10
titleSuffix: Microsoft Intune
description: Архив прошлых версий базовых показателей конфигурации безопасности MDM для управления Windows 10 с помощью Microsoft Intune
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 06/27/2019
...
ms.locfileid: "67418963"
---
<!-- This article contains the exact baseline details for baseline versions that were previously published in security-baseline-settings-mdm.md.  -->

# <a name="archive-of-mdm-security-baseline-settings"></a>Архив базовых показателей конфигурации безопасности MDM  

Просмотр сведений о архивные версии базовых показателей безопасности MDM для Intune.  

После выхода новых базовых показателей безопасности MDM вышеупомянутых параметров переместить из статьи базовые параметры безопасности этого архива. Эти версии по-прежнему поддерживаются для использования, и этот архив предоставляется для помощи в понимании параметры по умолчанию для более старых версий базовых показателей.

Если базовая версия больше не поддерживается для использования, он затем удаляется из этой статьи.

- Просмотрите параметры, доступные в [текущую базовую безопасности MDM](security-baseline-settings-mdm.md) 
- Дополнительные сведения о [базовые конфигурации безопасности](security-baselines.md)и обновление базовой версии в профилях базовых показателей безопасности.
...
*Этому шаблону базовой заменяется [базовых показателей безопасности MDM для Spring 2019 г. (19 H 1)](security-baseline-settings-mdm.md)*
...
[Просмотрите текущую версию базовых показателей](security-baseline-settings-mdm.md)  
[Обновление профиля для использования новой базовой версии](security-baselines.md#change-the-baseline-instance-for-a-profile)
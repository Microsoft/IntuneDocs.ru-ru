...
- Ознакомьтесь с базовыми показателями [безопасностииобновлениембазовойверсиивпрофилях](security-baselines.md)базовых показателей безопасности.
...
*Этот базовый план заменяется [базовым планом безопасности MDM для пружины 2019 (19H1)](security-baseline-settings-mdm.md)*

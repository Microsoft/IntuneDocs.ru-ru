...
> [!NOTE]
> На устройствах Android для бизнеса **Проверка угроз в приложениях** — это политика конфигурации устройства. Используя политики конфигурации, администраторы могут включить параметр на устройстве. См. раздел [Параметры ограничений для устройств Android для бизнеса](device-restrictions-android-for-work.md).
...
- **Требуемый тип пароля.** Укажите, каким должен быть пароль: содержать только цифровые символы или сочетание цифр и других символов. Доступны следующие параметры:
  ...
  - **По крайней мере буквы и цифры с символами**: введите **минимальную длину пароля** , которую должен ввести пользователь, от 4 до 16 символов.

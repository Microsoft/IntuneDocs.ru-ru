...
В следующем примере смартфонов с Windows 8.1 не смогут изменять сотовой сети во время путешествий вне зоны покрытия перевозчика.

- **Имя**: разрешить передачу данных по сотовой сети в роуминге
- **Описание**: разрешение или запрет перемещения данных по сотовой сети

...
8. На странице **Разрешения API** выберите **Предоставить согласие администратора для _\<ваш клиент>_** и щелкните **Да**.  После успешной регистрации приложения разрешения API должны выглядеть следующим образом:

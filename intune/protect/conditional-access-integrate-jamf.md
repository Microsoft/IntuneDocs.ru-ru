...
7. На странице разрешения API выберите **Добавить разрешение**, чтобы добавить новое разрешение. На странице **Запрос разрешений API** выберите **Intune**, а затем — **Разрешения приложений**. Установите только флажок **update_device_attributes**.

8. Подождите несколько минут, чтобы новое разрешение вступило в силу. Затем выберите **Предоставить согласие администратора для _\<ваш клиент>_** . Проверьте подлинность учетной записи в новом окне и предоставьте доступ к приложению, следуя инструкциям.  

9. Возможно, потребуется подождать еще несколько минут, чтобы согласие администратора вступило в силу.

10. Обновите страницу, нажав кнопку **Обновить** в верхней части. Убедитесь, что для разрешения **update_device_attributes** предоставлено согласие администратора. 

11. Удалите согласие администратора из разрешения **User.Read**, открыв меню **...** и выбрав **Отозвать согласие администратора**.

12. Также необходимо удалить разрешение **User.Read**. Откройте меню **...** для **User.Read** и выберите **Удалить разрешение**. 

8. После успешной регистрации приложения разрешения API должны содержать только одно разрешение, именуемое **update_device_attributes**, и выглядеть следующим образом:

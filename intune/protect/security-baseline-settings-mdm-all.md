...
description: Проверьте значения по умолчанию и доступные параметры для различных версий базового показателя Windows MDM конфигурациям, которыми можно управлять с помощью Microsoft Intune.
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 09/06/2019
...
- **Bit locker fixed drive policy** (Политика BitLocker в отношении жестких дисков)  
  ...
  - **Метод шифрования**
    **Значение по умолчанию**: AES-XTS, 256 бит  
...
- **Настройка безопасного доступа к UNC-путям**  
  ...
  **По умолчанию**: Настройка Windows для предоставления доступа только к указанным UNC-путям после выполнения дополнительных требований безопасности
...
- **безопасность на основе виртуализации**  
  **умолчанию**: включение vbs с безопасной загрузкой
::: zone-end
::: zone pivot="mdm-preview,mdm-may-2019"
...
- **Политика системного диска блокировки** *(все параметры)*

...
- **Настройка безопасного доступа к UNC-путям**.  
  ...
  **По умолчанию**: настройка Windows для разрешения доступа к указанным UNC-путям только после выполнения дополнительных требований безопасности.
...
- **Поддержка шифрования Internet Explorer**.  
  ...
  **По умолчанию**: 2 элемента — TLS 1.1 и TLS 1.2  

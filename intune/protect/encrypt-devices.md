...
Обратите внимание, что регистрация устройств, утвержденная пользователем, требуется для работы FileVault на устройстве. Утвержденной считается регистрация, при которой пользователь должен вручную утвердить профиль управления в системных параметрах для регистрации. 

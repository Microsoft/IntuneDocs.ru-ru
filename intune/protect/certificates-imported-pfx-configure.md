...
8. Чтобы проверить, был ли сертификат импортирован, выполните команду `Get-IntuneUserPfxCertificate -AuthenticationResult $authResult -UsertList "<UserUPN>"`.

...
>
> Это известная проблема с многопользовательскими устройствами с Windows 10. Любые изменения или обновления этого поведения объявляются в разделе [функций в разработке](../fundamentals/in-development.md) и (или) [новых возможностей](../fundamentals/whats-new.md).

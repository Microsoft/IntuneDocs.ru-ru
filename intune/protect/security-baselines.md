...
9. Создав профиль, его можно изменить, последовательно выбрав **Безопасность устройства** > **Security baselines** (Базовые конфигурации безопасности), укажите настроенный тип базовой конфигурации и выберите **Профили**. Выберите профиль из списка доступных профилей и щелкните **Свойства**. Можно изменять параметры на всех вкладках конфигурации, после чего нужно щелкнуть **Просмотреть и сохранить**, чтобы применить изменения.

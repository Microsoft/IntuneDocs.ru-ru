...
- **Соединитель сертификатов PFX для Microsoft Intune**.  
  ...
  См. сведения обо всех сетевых конечных точках, к которым должен иметь доступ соединитель в описании [конечных точек сети для Microsoft Intune](../fundamentals/intune-endpoints.md).

...
Чтобы найти отчет войдите в [центр администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431). Выберите **Устройства** > **Мониторинг**, а затем в *Конфигурации* щелкните **Отчет о шифровании**.

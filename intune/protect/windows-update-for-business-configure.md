...
> [!IMPORTANT]
> При развертывании *обновления компонентов Windows 10* и политики *круга обновления Windows 10* на одно и то же устройство, проверьте круг обновлений на следующие настройки:
>
> - **Период отсрочки обновления компонентов (в днях)** должен быть установлен на значение **0**
> - Обновления компонентов для круга обновления должны быть *запущены*. Их не следует приостанавливать.

Обновления компонентов Windows 10 не поддерживаются в Windows Автопилот.

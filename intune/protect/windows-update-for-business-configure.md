...
- Политика *обновления компонентов Windows 10* не поддерживается в Autopilot. Intune не поддерживает развертывание политики в таких случаях:
  - Устройства, которые подготавливаются с помощью Autopilot.
  - Устройства, ранее подготовленные с помощью Autopilot.

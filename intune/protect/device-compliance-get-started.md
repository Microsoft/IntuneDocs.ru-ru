...
> [!NOTE]
> Улучшенное обнаружение взлома для устройств iOS/iPadOS временно отключено в Intune.

- **Улучшенное обнаружение взлома**. Если этот параметр включен, устройства iOS/iPadOS чаще устанавливают связь с Intune. Это свойство использует службы определения местоположения устройства и влияет на расход заряда батареи. Intune не сохраняет данные о местоположении пользователя.

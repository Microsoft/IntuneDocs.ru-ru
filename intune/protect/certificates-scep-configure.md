...
- **Центр сертификации**: требуется центр сертификации (ЦС) предприятия служб сертификатов Microsoft Active Directory под управлением выпуска Enterprise Windows Server 2008 R2 с пакетом обновления 1 (SP1) или более поздней версии. Используемая версия Windows Server должна оставаться поддерживаемой корпорацией Майкрософт. Автономный ЦС не поддерживается. Дополнительные сведения см. в разделе [Установка центра сертификации](http://technet.microsoft.com/library/jj125375.aspx). Если ЦС выполняется под управлением Windows Server 2008 R2 с пакетом обновления 1 (SP1), необходимо [установить исправление из KB2483564](http://support.microsoft.com/kb/2483564/).  
...
- **Роль сервера NDES**: на сервере Windows Server 2012 R2 или более поздней версии настройте роль сервера "Служба регистрации сертификатов для сетевых устройств" (NDES). В следующем разделе этой статьи мы поможем вам [установить NDES](#set-up-ndes).  
  ...
  Дополнительные сведения об NDES см. в статье [Руководство по службе регистрации сетевых устройств](http://technet.microsoft.com/library/hh831498.aspx) или [Использование модуля политики со службой регистрации сертификатов для сетевых устройств](https://technet.microsoft.com/library/dn473016.aspx).  

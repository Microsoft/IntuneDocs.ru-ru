...
- **Защита сети**.  
  **Значение по умолчанию**: не настроено  
  ...
  - **Не настроено** — эта функция будет отключена. Пользователям и приложениям не заблокировано подключение к опасным доменам. Администраторы не могут просматривать эту активность в Центре безопасности в Microsoft Defender.  
...
- **Minimum Session Security For NTLM SSP Based Clients** (Минимальная сеансовая безопасность для клиентов на базе NTLM SSP)  
  **По умолчанию**: нет  
  CSP ЛокалполиЦиессекуритйоптионс: [NetworkSecurity_MinimumSessionSecurityForNTLMSSPBasedClients](https://aka.ms/policy-csp-localpoliciessecurityoptions-networksecurity-minimumsessionsecurityforntlmsspbasedclients)  
...
- **Minimum Session Security For NTLM SSP Based Server** (Минимальная сеансовая безопасность для серверов на базе NTLM SSP)  
  **По умолчанию**: нет  
  CSP ЛокалполиЦиессекуритйоптионс: [NetworkSecurity_MinimumSessionSecurityForNTLMSSPBasedServers](https://aka.ms/policy-csp-localpoliciessecurityoptions-networksecurity-minimumsessionsecurityforntlmsspbasedservers)  
...
- **Уровень проверки подлинности LAN Manager**  
  **По умолчанию**: LM и NTLM  
  CSP ЛокалполиЦиессекуритйоптионс: [NetworkSecurity_LANManagerAuthenticationLevel](https://aka.ms/policy-csp-localpoliciessecurityoptions-lanmanagerauthenticationlevel)  
...
- **Очистить файл подкачки виртуальной памяти при отключении устройства**  
  **Значение по умолчанию**: не настроено  
   CSP ЛокалполиЦиессекуритйоптионс: [Shutdown_ClearVirtualMemoryPageFile](https://go.microsoft.com/fwlink/?linkid=867914)  
...
- **Shut down without log on** (Завершение работы без входа)  
  **Значение по умолчанию**: не настроено  
  CSP ЛокалполиЦиессекуритйоптионс: [Shutdown_AllowSystemToBeShutDownWithoutHavingToLogOn](https://go.microsoft.com/fwlink/?linkid=867912)  
...
- **Уровень целостности UIA при запуске из небезопасных расположений**  
  **Значение по умолчанию**: "Не настроено"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_OnlyElevateUIAccessApplicationsThatAreInstalledInSecureLocations](https://go.microsoft.com/fwlink/?linkid=867897)  
...
- **Виртуализировать ошибки записи в файлы и в реестр в расположениях пользователей**  
  **Значение по умолчанию**: "Не настроено"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_VirtualizeFileAndRegistryWriteFailuresToPerUserLocations](https://go.microsoft.com/fwlink/?linkid=867900)  
...
- **Повышать права только для подписанных и проверенных исполняемых файлов**  
  **Значение по умолчанию**: "Не настроено"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_OnlyElevateUIAccessApplicationsThatAreInstalledInSecureLocations](https://go.microsoft.com/fwlink/?linkid=867965)  
...
- **Запрос на повышение привилегий для администраторов**  
  **Значение по умолчанию** — "Запрос согласия для исполняемых файлов, отличных от Windows"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_BehaviorOfTheElevationPromptForAdministrators](https://go.microsoft.com/fwlink/?linkid=867895)  
...
- **Повышение привилегий для обычных пользователей**  
  **Значение по умолчанию** — "Запрашивать учетные данные"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_BehaviorOfTheElevationPromptForStandardUsers](https://go.microsoft.com/fwlink/?linkid=867896)  
...
- **Направлять запросы на повышение привилегий на интерактивный рабочий стол пользователя**  
  **Значение по умолчанию**: "Не настроено"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_SwitchToTheSecureDesktopWhenPromptingForElevation](https://go.microsoft.com/fwlink/?linkid=867899)  
...
- **Запрос на повышение привилегий для установки приложений**  
  **Значение по умолчанию**: "Не настроено"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_DetectApplicationInstallationsAndPromptForElevation](https://go.microsoft.com/fwlink/?linkid=867901)  
...
- **Запрос на повышение привилегий UIA без использования безопасного рабочего стола**  
  **Значение по умолчанию**: "Не настроено"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_AllowUIAccessApplicationsToPromptForElevation](https://go.microsoft.com/fwlink/?linkid=867894)  
...
- **Режим одобрения администратором для встроенной учетной записи администратора**  
  **Значение по умолчанию**: "Не настроено"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_UseAdminApprovalMode](https://go.microsoft.com/fwlink/?linkid=867902)  
...
- **Запуск всех администраторов в режиме одобрения администратором**  
  **Значение по умолчанию**: "Не настроено"  
  CSP ЛокалполиЦиессекуритйоптионс: [UserAccountControl_RunAllAdministratorsInAdminApprovalMode](https://go.microsoft.com/fwlink/?linkid=867898)  
...
- **Связь с цифровой подписью (с согласия сервера)**  
  **Значение по умолчанию**: не настроено  
  CSP ЛокалполиЦиессекуритйоптионс: [MicrosoftNetworkClient_DigitallySignCommunicationsIfServerAgrees](https://go.microsoft.com/fwlink/?linkid=868423)  
...
- **Отправлять незашифрованные пароли на сторонние серверы SMB**  
  **Значение по умолчанию**: не настроено  
  CSP ЛокалполиЦиессекуритйоптионс: [MicrosoftNetworkClient_SendUnencryptedPasswordToThirdPartySMBServers](https://go.microsoft.com/fwlink/?linkid=868426)  
...
- **Связь с цифровой подписью (всегда)**  
  **Значение по умолчанию**: не настроено  
  CSP ЛокалполиЦиессекуритйоптионс: [MicrosoftNetworkClient_DigitallySignCommunicationsAlways](https://go.microsoft.com/fwlink/?linkid=868425)  
...
## <a name="user-rights"></a>Права пользователя

- **Доступ к диспетчеру учетных данных от имени доверенного вызывающего**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/акцесскредентиалманажераструстедкаллер](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-accesscredentialmanagerastrustedcaller)
...
- **Разрешить локальный вход**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/алловлокаллогон](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-allowlocallogon)
...
- **Разрешить доступ из сети**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/акцессфромнетворк](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-accessfromnetwork)
...
- **Работа в составе ОС**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/актаспартофсеоператингсистем](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-actaspartoftheoperatingsystem)
...
- **Архивация файлов и каталогов**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/баккупфилесанддиректориес](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-backupfilesanddirectories)

  Это право пользователя определяет, какие пользователи могут обходить разрешения на файлы, каталоги, реестр и другие постоянные объекты при резервном копировании файлов и каталогов.
  - **Не настроено**.
  - **Разрешить**

- **Изменение системного времени**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/чанжесистемтиме](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-changesystemtime)

  Это право пользователя определяет, какие пользователи и группы могут изменять время и дату на внутреннем часовом компьютере.
  - **Не настроено**.
  - **Разрешить**

- **Создание глобальных объектов**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/креатеглобалобжектс](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-createglobalobjects)

  Этот параметр безопасности определяет, могут ли пользователи создавать глобальные объекты, доступные для всех сеансов. Пользователи, которые могут создавать глобальные объекты, могут повлиять на процессы, выполняемые с сеансами других пользователей, что может привести к сбою приложения или повреждению данных.
  - **Не настроено**.
  - **Разрешить**

- **Создать файл подкачки**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/креатепажефиле](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-createpagefile)
...
- **Создание постоянных общих объектов**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/креатеперманентшаредобжектс](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-createpermanentsharedobjects)
...
- **Создание символических ссылок**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/креатесимболиклинкс](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-createsymboliclinks)

  Это право пользователя определяет, может ли пользователь создать символьную ссылку с компьютера, на который они вошли.
  - **Не настроено**.
  - **Разрешить**

- **Создание токенов**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/креатетокен](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-createtoken)

  Это право пользователя определяет, какие пользователи или группы могут использоваться процессами для создания маркера, который затем может использоваться для получения доступа к любым локальным ресурсам, когда процесс использует внутренний API для создания маркера доступа.
  - **Не настроено**.
  - **Разрешить**

- **Отладка программ**  
  **Значение по умолчанию**: не настроено  
    CSP: [UserRights/дебугпрограмс](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-debugprograms)

  Это право пользователя определяет, какие пользователи могут подключать отладчик к любому процессу или ядру.
  - **Не настроено**.
  - **Разрешить**

- **Запретить доступ из сети**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/денякцессфромнетворк](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-denyaccessfromnetwork)
...
- **Отказ во входе в качестве службы**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/денилокаллогон](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-denylocallogon)
...
- **Запрет входа в систему через службу удаленных рабочих столов**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/дениремотедесктопсервицеслогон](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-denyremotedesktopserviceslogon)

  Это право пользователя определяет, какие пользователи и группы запрещены для входа в систему в качестве клиента службы удаленных рабочих столов.
  - **Не настроено**.
  - **Разрешить**

- **Включить делегирование**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/енабледелегатион](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-enabledelegation)
...
- **Создание аудитов безопасности**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/женератесекуритяудитс](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-generatesecurityaudits)
...
- **Олицетворение клиента**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/имперсонатеклиент](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-impersonateclient)

  Назначение этому пользователю права пользователя позволяет программам, выполняемым от имени этого пользователя, олицетворять клиента. Необходимость этого пользователя для такого рода олицетворения не позволяет неавторизованному пользователю убедить клиента подключиться к созданной службе, а затем олицетворять этого клиента, что может повысить уровень разрешений неавторизованного пользователя до административные или системные уровни.
  - **Не настроено**.
  - **Разрешить**

- **Увеличение приоритета выполнения**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/инкреасесчедулингприорити](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-increaseschedulingpriority)
...
- **Загрузка и выгрузка драйверов устройств**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/лоадунлоаддевицедриверс](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-loadunloaddevicedrivers)
...
- **Блокировка страниц в памяти**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/локкмемори](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-lockmemory)
...
- **Управление журналом аудита и безопасности**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/манажеаудитингандсекуритилог](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-manageauditingandsecuritylog)

  Это право пользователя определяет, какие пользователи могут задавать параметры аудита доступа к объектам для отдельных ресурсов, таких как файлы, Active Directory объекты и разделы реестра.
  - **Не настроено**.
  - **Разрешить**

- **Выполнение задач по обслуживанию томов**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/манажеволуме](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-managevolume)

  Это право пользователя определяет, какие пользователи и группы могут выполнять задачи обслуживания на томе, например удаленную дефрагментацию.
  - **Не настроено**.
  - **Разрешить**

- **Изменение значений среды встроенного ПО**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/модифифирмваринвиронмент](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-modifyfirmwareenvironment)
...
- **Изменение метки объекта**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/модифйобжектлабел](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-modifyobjectlabel)
...
- **Профилирование одного процесса**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/профилесинглепроцесс](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-profilesingleprocess)

  Это право пользователя определяет, какие пользователи могут использовать средства наблюдения за производительностью для наблюдения за производительностью системных процессов.
  - **Не настроено**.
  - **Разрешить**

- **Удаленное завершение работы**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/ремотешутдовн](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-remoteshutdown)

  Это право пользователя определяет, каким пользователям разрешено завершать работу компьютера из удаленного расположения в сети. Неправильное использование этого права пользователя может привести к отказу в обслуживании.
  - **Не настроено**.
  - **Разрешить**
  
- **Восстановление файлов и каталогов**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/ресторефилесанддиректориес](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-restorefilesanddirectories)
  
  Это право пользователя определяет, какие пользователи могут обходить разрешения на файлы, каталоги, реестр и другие постоянные объекты при восстановлении резервных копий файлов и каталогов, а также определяет, какие пользователи могут устанавливать любой допустимый субъект безопасности в качестве владельца объекта.
  - **Не настроено**.
  - **Разрешить**
  
- **Смена владельцев файлов или объектов**  
  **Значение по умолчанию**: не настроено  
  CSP: [UserRights/такеовнершип](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-userrights#userrights-takeownership)

  Это право пользователя определяет, какие пользователи могут становиться владельцами любого защищаемого объекта в системе, включая Active Directory объекты, файлы и папки, принтеры, разделы реестра, процессы и потоки.
  - **Не настроено**.
  - **Разрешить**

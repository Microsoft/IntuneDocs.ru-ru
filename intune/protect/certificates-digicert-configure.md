...
2. Создайте профиль доверенного сертификата, выполнив следующие действия на портале Intune.
   ...
   a. Войдите в [центр администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431).

...
Дополнительные сведения о настройке названия, контактных данных и логотипа компании см. в разделе [Данные организации и заявление о конфиденциальности](../apps/company-portal-app.md#company-information-and-privacy-statement), [Сведения о поддержке](../apps/company-portal-app.md#support-information) и [Настройка фирменной символики организации](../apps/company-portal-app.md#company-identity-branding-customization). 
...
11. Выберите **Добавить** > **ОК** > **Сохранить** для сохранения изменений.

...
- **Требовать защиту целостности системы**:  
  ...
  - Чтобы включить [защиту целостности системы](https://support.apple.com/HT204899) (открывает веб-сайт Apple) **, необходимо использовать** устройства macOS.  
...
- **Простые пароли**.  
  - **Не настроено** (*по умолчанию*) — пользователи могут создавать пароли простыми, например **1234** или **1111**.
...
- **Не настроено** (*по умолчанию*). Параметр привратника не влияет на соответствие или несоответствие.  

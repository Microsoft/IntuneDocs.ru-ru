...
## <a name="errors-returned-by-ios-devices"></a>Ошибки, возвращаемые устройствами iOS
...
|-2016345603|0x87D101FD|Syncml(509): Зарезервирован для использования в будущем.|
...
|-2016345698|0x87D1019E|Syncml(414): не удалось выполнить команду, поскольку универсальный код ресурса имеет слишком большую длину, чтобы получатель мог или был готов его обработать.|
...
|-2016345701|0x87D1019B|Syncml(411): для запрашиваемой команды также необходимо указать размер в байтах или сведения о длине в элемента типа Meta.|

...
- скачаете, установите и настроите соединитель сертификатов на сервере NDES.
   ...
   > [!NOTE]
   > Для поддержки высокой доступности можно установить несколько экземпляров соединителя сертификатов.

<!--1528104 we need to flesh out the HA recommendation in the note above -->

##### <a name="to-enable-support-for-the-certificate-connector"></a>Чтобы включить поддержку для соединителя сертификатов:
...
##### <a name="to-download-install-and-configure-the-certificate-connector"></a>Чтобы скачать, установить и настроить соединитель сертификатов:

...
description: "Предварительная версия Intune Azure. Сведения о настройке инфраструктуры, создании и назначении профилей сертификатов SCEP в Intune."
keywords: 
...
> [!NOTE]
> Из-за известной проблемы скачивать, устанавливать и настраивать соединитель сертификатов, следует с помощью следующей процедуры: [Настройка инфраструктуры сертификата для SCEP -> Настройка инфраструктуры -> Задача 5](https://docs.microsoft.com/intune-classic/deploy-use/certificates-scep-configure#a-namebkmkconfigureinfrastructureaconfigure-your-infrastructure)

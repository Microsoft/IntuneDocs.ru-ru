...
- **Соединитель Microsoft Intune Certificate Connector**: скачайте установщик **соединителя** (**ndesconnectorssetup.exe**) на портале администрирования Intune. Вы будете запускать этот установщик на сервере с ролью NDES.  

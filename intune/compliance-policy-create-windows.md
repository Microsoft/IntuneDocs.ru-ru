...
- **Минимальная версия ОС**. Введите минимальную допустимую версию в числовом формате основной_номер.дополнительный_номер.сборка.редакция. Номер в виде "сборка.редакция" должен соответствовать версии, возвращенной командой `ver` или `winver`.
...
- **Максимальная версия ОС**. Введите максимальную допустимую версию в числовом формате основной_номер.дополнительный_номер.сборка.редакция. Номер в виде "сборка.редакция" должен соответствовать версии, возвращенной командой `ver` или `winver`.

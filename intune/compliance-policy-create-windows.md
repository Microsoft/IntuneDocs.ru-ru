...
- **Минимальная версия ОС**. Введите минимальную допустимую версию в числовом формате major.minor.build.CU. Номер в виде "сборка.накопительное обновление" должен соответствовать версии, возвращенной командой `ver` или `winver`.
...
- **Максимальная версия ОС**. Введите максимальную допустимую версию в числовом формате major.minor.build.CU. Номер в виде "сборка.накопительное обновление" должен соответствовать версии, возвращенной командой `ver` или `winver`.

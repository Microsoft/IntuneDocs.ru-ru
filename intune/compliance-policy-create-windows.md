...
- **Минимальное число наборов символов.** Поддерживается в Windows RT, Windows RT 8.1 и Windows 8.1. Если для параметра **Требуемый тип пароля** задано значение **Буквенно-цифровой**, этот параметр указывает минимальное число наборов символов, которое должен содержать пароль. Используются следующие четыре набора символов.
  ...
  - Numbers 
    ...
    Чем больше значение этого параметра, тем более сложные пароли должны будут создавать пользователи. Для устройств, доступ к которым осуществляется с помощью учетной записи Майкрософт, политика соответствия не сможет корректно выполнить анализ, если **Минимальная длина пароля** больше восьми символов или если **Минимальное число наборов символов** больше двух.
...
- **Минимальная требуемая ОС**. Поддерживается в Windows 8.1 и Windows 10.
  ...
  Укажите здесь номер в виде основная.дополнительная.сборка.накопительное обновление. Номер в виде "сборка.накопительное обновление" должен соответствовать версии, возвращенной командой ```winver```.

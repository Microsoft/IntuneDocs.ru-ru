...
Укажите здесь номер в виде основная.дополнительная.сборка.накопительное обновление. Номер версии должен соответствовать версии, возвращенной командой ```winver```.

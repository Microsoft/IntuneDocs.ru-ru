...
description: "Узнайте, как создать политику соответствия требованиям для устройств с Windows.\""
keywords: 
author: andredm7
ms.author: andredm
manager: dougeby
...
3. Выберите **Требования соответствия**, чтобы открыть колонку требований соответствия.  Вы можете задать здесь параметры **Безопасности**, **Работоспособности устройства** и **Свойств устройства**. По завершении нажмите кнопку **ОК**.
...
Чтобы узнать версию для параметров **Минимальная требуемая ОС** и **Максимально допустимая версия ОС**, выполните команду **winver** из командной строки. Команда winver возвращает обнаруженную версию операционной системы.

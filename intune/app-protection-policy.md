...
![Изображение, на котором демонстрируется защита корпоративных данных при применении политик защиты приложений ](./media/apps-with-protection-policies.png)

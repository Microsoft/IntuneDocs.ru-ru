...
* В настоящее время вы можете назначать книги только как **обязательные** для установки. При назначении электронной книги с помощью действия **Обязательная установка** на каждого пользователя, который ее устанавливает, расходуется отдельная лицензия.
...
Выберите действие назначения **Обязательно**. 

...
ms.locfileid: "56891612"
---
# <a name="what-is-microsoft-intune"></a>Что такое Microsoft Intune?

[!INCLUDE [both-portals](./includes/note-for-both-portals.md)]

Intune — это облачная служба в среде управления корпоративной мобильностью (EMM), которая повышает производительность труда персонала, при этом обеспечивая защиту корпоративных данных. Так же как другие службы Azure, решение Microsoft Intune доступно на портале Azure. С помощью Intune можно выполнять следующие задачи:

...
| Windows | Гибридное присоединение AADJ и автоматическая регистрация GPO | Первый пользователь, вошедший в систему | Когда первый пользователь выполняет вход | 
| Windows | Совместное управление | Первый пользователь, вошедший в систему | Когда первый пользователь выполняет вход | 

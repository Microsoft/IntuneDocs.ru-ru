...
- Прямая регистрация. Этот процесс не сбрасывает устройство к заводским настройкам и регистрирует его, используя предварительно заданную политику. Этот способ предназначен для устройств без сопоставления пользователей.

...
### <a name="dedicated-device-settings"></a>Параметры устройства, выделенного

Используйте эти параметры для настройки взаимодействия Киоск-на выделенных устройствах. Устройство можно настроить на запуск одного или нескольких приложений. Когда устройство находится в режиме киоска, доступны только добавляемые вами приложения. Эти параметры применяются к устройствам Android для бизнеса выделенной. Они не применяются к устройствам Android управляемые для бизнеса.

**Режим киоска**: выберите, если устройство использует одно приложение или несколько приложений.
...
- **Несколько приложений**. Пользователям доступен ограниченный набор приложений на устройстве. При запуске устройства запускаются только добавленные вами приложения. Можно также добавлять веб-ссылки, которые пользователи могут открывать. При применении этой политики на начальном экране отображаются значки разрешенных приложений.
  ...
  - **Выйти из режима киоска**. Выберите **Включить**, чтобы администраторы могли временно приостанавливать режим киоска для обновления устройства. Чтобы использовать эту функцию, администратор: 
...
- **Отключить возможности экрана блокировки**: при включении экрана блокировки на устройстве выберите какие возможности нужно отключить. Например, если установлен флажок **Защита камеры**, камеры будет отключена на устройстве. Не выбранные здесь функции будут включены на устройстве.

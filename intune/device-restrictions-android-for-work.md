...
- **Несколько приложений**. Пользователям доступен ограниченный набор приложений на устройстве. При запуске устройства запускаются только добавленные вами приложения. Можно также добавлять веб-ссылки, которые пользователи могут открывать. При применении этой политики на начальном экране отображаются значки разрешенных приложений.
  ...
  >
  > При использовании режима киоска с несколькими приложениями с управляемым начальным экраном приложения номеронабирателя и телефона могут работать неправильно. 
  ...
  - **Конфигурация Wi-Fi**. Выберите значение **Включить**, чтобы разрешить пользователям подключать устройство к различным сетям Wi-Fi. При включении этой функции также включается местоположение устройства. Значение **Не настроено** (значение по умолчанию) запрещает пользователям подключаться к сетям Wi-Fi, находясь в приложении Managed Home Screen (режим блокировки задач).

    Подробнее о [режиме блокировки задач](https://developer.android.com/work/dpc/dedicated-devices/lock-task-mode) (откроется веб-сайт Android).

  - **Конфигурация Bluetooth**. Выберите значение **Включить**, чтобы разрешить использование Bluetooth на устройстве и разрешить конечным пользователям выполнять сопряжение устройств по Bluetooth. При включении этой функции также включается местоположение устройства. Значение **Не настроено** (значение по умолчанию) запрещает пользователям настраивать Bluetooth и выполнять сопряжение, находясь в приложении Managed Home Screen (режим блокировки задач). 

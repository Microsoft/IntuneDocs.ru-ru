...
2. На панели **Политика** выберите **Назначения**. Откроется панель **Защита приложений Intune — назначения**. Нажмите **Выбрать группы для включения** на панели **Назначения**, чтобы открыть панель **Выбрать группы для включения**.

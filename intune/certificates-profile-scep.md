...
5. В раскрывающемся списке **Тип профиля** выберите **Сертификат SCEP**.  
   ...
   3. Отзыв сертификатов, подготовленных профилями сертификатов SCEP для владельца устройства, не поддерживается в Intune, но им можно управлять с помощью внешнего процесса или непосредственно с помощью центра сертификации.

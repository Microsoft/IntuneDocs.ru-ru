...
description: "В этой статье приводятся сведения по выбору групп для развертывания Intune и определению соответствующих сроков развертывания."
keywords: 
author: andredm7
ms.author: andredm
manager: angrobe
...
## Целевые группы и временные интервалы
...
## Сопоставление групп развертывания и способов регистрации

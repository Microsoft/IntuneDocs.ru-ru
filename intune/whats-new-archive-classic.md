...
Теперь вы можете создать политику условного доступа на основе приложения, чтобы запретить для приложений, к которым не применены политики защиты приложения, доступ к [SharePoint Online](app-based-conditional-access-intune-create.md). В сценарии условного доступа на основе приложений можно указать приложения, которые будут получать доступ к SharePoint Online с помощью портала Azure.

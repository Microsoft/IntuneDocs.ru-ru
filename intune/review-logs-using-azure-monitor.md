...
3. Укажите следующие свойства.
    ...
    - **LOG** > **OperationalLogs**. Операционные журналы (предварительная версия) отображают успехи или неудачи пользователей и устройств, которые регистрируются в Intune. Выберите этот параметр, чтобы отправить журналы регистрации в учетную запись хранения, концентратор событий или Log Analytics.

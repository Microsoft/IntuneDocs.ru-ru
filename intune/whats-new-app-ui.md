...
### <a name="end-user-messaging-for-accounts---1573558-1712-changes-to-be-made-for-other-platforms-for-1801--"></a>Оповещение пользователей об учетных записях <!--1573558, 1712; changes to be made for other platforms for 1801-->

Пользователи веб-сайта "Корпоративный портал" не смогут выполнять действия, для которых требуется доступ на запись в ваш клиент. Они увидят соответствующее сообщение об ошибке, в котором объясняется, что учетная запись находится на обслуживании. Аналогичные изменения скоро будут доступны для приложений "Корпоративный портал" для Android, iOS, macOS и Windows.

![Сообщение об ошибке, которое возникло во время перемещения учетной записи](./media/account-move-rom-iwp-user-1712.png)

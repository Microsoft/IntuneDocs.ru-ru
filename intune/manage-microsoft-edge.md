...
3. В колонке в разделе **Элементы управления доступом** выберите **Назначить**.
4. Выберите **Require approved client app** (Требовать утвержденное клиентское приложение).
5. В колонке **Назначение** щелкните **Выбрать**. Эту политику необходимо назначить облачным приложениям, которые должны быть доступны только приложению Intune Managed Browser.

    ![Снимок экрана: назначение политики условного доступа](./media/manage-microsoft-edge/manage-microsoft-edge-01.png)

6. В разделе "Назначения" выберите **Условия** > **Клиентские приложения**. Откроется колонка **Клиентские приложения**.
...
5. Щелкните **Выбрать нужное приложение**. Затем в колонке **Целевые приложения** выберите **Managed Browser** или **Edge** для iOS, Android или обеих платформ.
6. Щелкните **ОК**, чтобы вернуться к колонке **Добавить политику конфигурации**.
...
4. В колонке **Назначения** выберите группу Azure AD, которой нужно назначить конфигурацию приложения, а затем щелкните **ОК**.

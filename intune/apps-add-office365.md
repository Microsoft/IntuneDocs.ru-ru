...
6. В области **Добавление приложений** найдите список **Тип приложения** в разделе **Office 365 Office** и выберите **Windows 10**.
...
>[!IMPORTANT]
> Завершив создание набора приложений, вы уже не сможете изменить его свойства. Чтобы задать другие свойства, удалите набор приложений и создайте новый.
...
2. В области **Параметры набора приложений** сделайте следующее:
    ...
    - **Use shared computer activation** (Использовать активацию на общем компьютере). Выберите этот параметр, если на компьютере работают несколько пользователей. См. дополнительные сведения см. об активации на общем компьютере для Office 365.

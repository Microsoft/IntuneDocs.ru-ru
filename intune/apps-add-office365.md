...
---
# <a name="how-to-assign-office-365-apps-to-windows-10-devices-with-microsoft-intune"></a>Как назначить приложения Office 365 устройствам на базе Windows 10 с помощью Microsoft Intune
...
- Intune поддерживает добавление приложений Office только из пакета Office 365.
...
2.  Последовательно выберите **Все службы** > **Intune**. Intune находится в разделе **Мониторинг и управление**.
...
6.  В списке **Тип приложения** в колонке **Добавление приложений** выберите **Windows 10** в разделе **Пакет Office 365**.
...
На этом шаге укажите сведения о пакете приложений. Эти сведения помогут вам определить пакет приложений в Intune, а пользователям — найти его в приложении корпоративного портала.
...
2.  В колонке **Сведения о наборе приложений** укажите следующие сведения.
    ...
    - **Логотип**. Это значок, который будет отображаться с приложением при просмотре пользователями корпоративного портала.
3.  По завершении нажмите кнопку **ОК**.
...
2.  В колонке **Параметры набора приложений** укажите следующие сведения.
    ...
    - **Использовать активацию на общем компьютере**. Такая активация применяется, если на компьютере работают несколько пользователей. См. дополнительные сведения см. об активации на общем компьютере для Office 365.
...
Когда закончите, на панели **Добавление приложения** нажмите кнопку **ОК**. Созданное вами приложение появится в списке приложений.
...
- Теперь вы можете [назначать приложения выбранным группам](/intune-azure/manage-apps/deploy-apps).

...
При назначении приложения пользователям используется одна лицензия приложения, которая связывается с пользователем. Приложение можно запускать на нескольких устройствах, которыми владеет пользователь.
При назначении приложений, приобретенных по программе корпоративных закупок, пользователям каждый пользователь должен иметь допустимый идентификатор Apple для доступа к магазину приложений.

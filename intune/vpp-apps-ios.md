...
4. В колонке **Создать токен VPP** укажите следующие сведения:
    ...
    - **Автоматическое обновление приложений** — выберите **Вкл.**, чтобы включить автоматическое обновление, или **Выкл.**, чтобы отключить его. Если этот параметр включен, Intune обновляет все приложения, приобретенные для указанного токена, через службу Intune при их регистрации в сети. Intune обнаруживает обновления для приложений VPP в App Store и автоматически отправляет их на устройство при его регистрации в сети.
...
|---|--------------------------------------------------|-------------------------------------------------------------------------------------------------|---------------------------------------------|-----------------------------------|
| 1 | BYOD — лицензируется пользователем                             | Y                                                                                               | Да                                           | Y                                 |
| 2 | Корпоративное — лицензируется пользователем (не контролируемое устройство)     | Y                                                                                               | Да                                           | Y                                 |

...
- **S/MIME**. **Включите S/MIME**, чтобы пользователи могли войти и шифровать электронную почту в собственном почтовом приложении для iOS. 
  ...
  - **Сертификат подписывания S/MIME**. Выберите существующий профиль сертификата PKCS или SCEP, используемый для подписи сообщений электронной почты.
    - **Разрешить пользователю изменять параметр**: выберите **включить** пользователям изменить сертификат подписи. Вариант **Отключить** запрещает пользователям изменять сертификат для подписи и вынуждает пользователей использовать сертификат, который вы настроили. Доступно в iOS 12 и более поздних версиях.

  - **Шифрование по умолчанию**: **включить** шифрует все сообщения, в качестве поведения по умолчанию. Значение **Отключить** не шифрует какие-либо сообщения по умолчанию.
    - **Разрешить пользователю изменять параметр**: выберите **включить** пользователям изменить поведение по умолчанию шифрования. Вариант **Отключить** запрещает пользователям изменять поведение по умолчанию и вынуждает пользователей использовать параметр, который вы настроили. Доступно в iOS 12 и более поздних версиях.
  ...
  - **Сертификат шифрования S/MIME**. Выберите существующий профиль сертификата PKCS или SCEP, используемый для шифрования сообщений электронной почты.
    - **Разрешить пользователю изменять параметр**: выберите **включить** пользователям изменить сертификат шифрования. Вариант **Отключить** запрещает пользователям изменять сертификат для шифрования и вынуждает пользователей использовать сертификат, который вы настроили. Доступно в iOS 12 и более поздних версиях.

...
**Шаг 3. Введите идентификатор Apple ID, с помощью которого был создан токен программы регистрации.**<br>В Intune на портале Azure укажите идентификатор Apple ID для дальнейшего применения. Используйте этот идентификатор для продления срока действия токена программы регистрации в будущем, чтобы предотвратить необходимость в повторной регистрации всех устройств.

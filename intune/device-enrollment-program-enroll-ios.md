...
5. Если выбран вариант **Регистрация со сходством пользователей**, вы можете разрешить пользователям выполнять аутентификацию с помощью корпоративного портала, а не помощника по настройке Apple.
    ...
    > [!NOTE]
    > Многофакторная проверка подлинности не работает при регистрации DEP, если в свойствах профиля задано значение **Регистрация со сходством пользователей**, а параметр **Проверка подлинности с помощью корпоративного портала, а не с помощником по настройке Apple** имеет значение **Нет**. После регистрации MFA работает на этих устройствах должным образом. Устройства не могут предложить изменить пароль пользователям при первом входе. Кроме того, пользователям, срок действия паролей которых истек, не будет предложено сбросить пароль во время регистрации. Им потребуется сбросить пароль с другого устройства.

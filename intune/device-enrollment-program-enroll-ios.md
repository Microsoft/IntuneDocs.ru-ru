...
1. В Intune на портале Azure выберите **Регистрация устройства** >  **Регистрация Apple** > **Устройства программы регистрации**.
2. В разделе **Устройства программы регистрации** выберите **Синхронизировать**.

...
### <a name="plan-for-change-intune-moving-to-support-ios-11-and-higher-in-september----4665324--"></a>Подготовьтесь к изменениям. Перевод Intune в сентябре на поддержку iOS 11 и более поздних версий в сентябре <!-- 4665324-->
...
Если вы используете политики защиты приложений, для доступа можно также настроить требование минимальной версии для операционной системы iOS (только в качестве предупреждения).
...
#### <a name="additional-information"></a>Дополнительные сведения
[Подготовка бизнес-приложений для политик защиты приложений](../apps-prepare-mobile-application-management.md)

...
- **Блокировать сторонние обновления PKI**: **запретить** пользователям получать обновления программного обеспечения без подключения устройств к компьютеру. **Не настроено** (по умолчанию) не обновляет этот параметр на устройстве.
...
- **Разрешить Аксессуары USB, когда устройство заблокировано**: **Разрешить** стандартные USB обмен данными с устройством, которое заблокировано в течение часа. **Не настроено** (по умолчанию) не обновляет ограниченный режим USB на устройстве.

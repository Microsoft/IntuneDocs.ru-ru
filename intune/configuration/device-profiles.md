...
В статье [Политики обновления iOS](../protect/software-updates-ios.md) показано, как создавать и назначать политики iOS для установки обновлений программного обеспечения на устройствах iOS. Кроме того, можно просмотреть состояние установки.

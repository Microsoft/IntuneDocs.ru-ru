...
Вы можете создать профиль с определенными параметрами Wi-Fi и развернуть этот профиль для устройств Android для бизнеса и выделенных устройств Android. Microsoft Intune предлагает множество возможностей, в том числе аутентификация в сети, использование общего ключа и многое другое.
...
Выберите этот вариант, если выделенное устройство Android для бизнеса используется в качестве киоска.

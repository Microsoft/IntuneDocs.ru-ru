...
- **Минимальная версия TLS в диапазоне**. Введите самую раннюю версию протокола TLS для использования. Введите `1.0`, `1.1` или `1.2`. Если оставить это поле пустым, будет использоваться значение по умолчанию `1.0`.

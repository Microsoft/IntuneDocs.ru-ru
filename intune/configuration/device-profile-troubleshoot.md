...
| Компьютеры под управлением Windows 10, зарегистрированные как устройства | Каждые 3 минуты в течение 30 минут, затем примерно каждые 8 часов | 
...
Пользователи могут в любое время открыть приложение "Корпоративный портал" и синхронизировать устройство, чтобы моментально проверить обновления политики или профиля.

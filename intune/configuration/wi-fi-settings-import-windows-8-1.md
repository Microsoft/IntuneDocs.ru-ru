...
3. Выполните команду `netsh wlan show profiles`. Запишите имя профиля, который вы хотите экспортировать. В этом примере профиль имеет имя **WiFiName**.
...
4. Введите следующие параметры:
    ...
    - **Имя подключения**. Введите имя подключения Wi-Fi. Это имя отображается для пользователей при просмотре доступных сетей Wi-Fi.

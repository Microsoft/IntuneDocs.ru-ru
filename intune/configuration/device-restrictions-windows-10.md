...
- **Разрешить мониторинг поведения**. Значение **Включить** разрешает мониторинг поведения и проверяет наличие определенных типичных подозрительных действий на устройствах. Пользователи не могут отключить контроль поведения. 
...
- **Отправка образцов согласие**: в настоящее время этот параметр не оказывает влияния. Не используйте этот параметр. Она может быть удалена в следующем выпуске.

...
- **Установить приложения с повышенными привилегиями**. **Блокировать** — настраивает установщик Windows так, чтобы при установке любых программ в системе он использовал повышенные разрешения. Эти привилегии распространяются на все программы. Если задано значение **Не настроено** (по умолчанию), Intune не изменяет или не обновляет этот параметр. По умолчанию система может применять текущие разрешения пользователя при установке программ, не развернутых или не предлагаемых системным администратором. 

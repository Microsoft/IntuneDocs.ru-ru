...
- **При защите доступа**: значение **Заблокировать** запрещает сканирование файлов, которые были доступны или скачаны. Пользователи не могут отключить этот параметр.

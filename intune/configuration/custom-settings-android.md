...
3. Введите следующие параметры:
    ...
    - **Имя** — Введите описательное имя для нового профиля. Назначьте имена профилям, чтобы позже их можно было легко найти. Например, хорошим именем профиля является **Настраиваемый профиль Android**.
...
Создание [настраиваемого профиля на устройствах Android Enterprise](custom-settings-android-for-work.md).

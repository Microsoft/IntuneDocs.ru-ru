...
При следующей синхронизации или перезагрузке устройства применяются параметры профиля DFCI. После применения политики перезагрузите устройство.

Когда устройство запускает программу установки устройств Windows, DFCI может принудительно выполнить перезагрузку на странице состояния регистрации. После завершения установки можно убедиться, что параметры DFCI активны, путем перезагрузки устройства. Затем используйте инструкции изготовителя устройства, чтобы открыть меню UEFI.
...
1. Откройте профиль DFCI (**Конфигурация устройства** > **Профили**).

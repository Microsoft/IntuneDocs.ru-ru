...
4. В качестве **платформы** выберите **macOS**. 
5. Выберите **Настройка параметров** и укажите данные в полях **Работоспособность устройства**, **Свойства устройства** и **Безопасность системы**, как описано ранее в этой статье. По окончании нажмите кнопки **ОК** и **Создать**.

...
---
# <a name="create-a-device-compliance-policy-for-macos-devices-preview-with-intune"></a>Создание политики соответствия устройств с macOS (предварительная версия) при помощи Intune

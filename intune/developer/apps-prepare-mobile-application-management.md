...
|Целевая Конфигурация приложения (или Конфигурация приложения с помощью канала MAM)|X||
...
|SafetyNet аттестация устройства (только для Android)|X|X|

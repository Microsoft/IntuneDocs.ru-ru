...
Для устройств, зарегистрированных с помощью учетной записи диспетчера регистрации, действуют следующие ограничения.
  ...
  - Если вы регистрируете устройства iOS при помощи DEM, вы не сможете использовать Apple Configurator, программу регистрации устройств Apple (DEP) или Apple School Manager (ASM) в процессе регистрации (только iOS). Это означает, что вы не можете перевести устройство в защищенный режим, и поэтому у вас не будет доступа к некоторым параметрам конфигурации.

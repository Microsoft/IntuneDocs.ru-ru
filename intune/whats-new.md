...
В приложении корпоративного портала для устройств с macOS улучшена процедура подачи отзывов о связанных с Intune ошибках. Из приложения корпоративного портала ваши сотрудники могут:
...
В приложение корпоративного портала Intune для Windows 10 добавлено [представление навигации Fluent Design System](https://docs.microsoft.com/en-us/windows/uwp/design/basics/navigation-basics). В боковой части приложения находится статический вертикальный список всех страниц верхнего уровня. Щелкайте любую ссылку, чтобы быстро просматривать страницы и переключаться между ними. Это первое из серии обновлений, направленных на то, чтобы сделать решение Intune более адаптивным, привычным и способствующим эффективной работе. Обновленный интерфейс см. в статье [Новые возможности пользовательского интерфейса приложения](whats-new-app-ui.md).
...
### <a name="plan-for-change-windows-company-portal-send-feedback-option-may-no-longer-work"></a>Планирование изменения: функция отправки отзывов на корпоративном портале Windows может перестать работать  
На корпоративном портале Windows предусмотрена функция **Отправить отзыв**, с помощью которой пользователи могут поделиться своим мнением о приложении с корпорацией Майкрософт. С 30 апреля 2018 г. эта функция будет поддерживаться только в приложениях корпоративного портала Windows 10, выполняющихся в ОС Windows 10 версии 1607 (юбилейное обновление) или более поздней.  

#### <a name="how-does-this-affect-me"></a>Как это повлияет на работу?  
Если у вас не установлено приложение корпоративного портала Windows для конечных пользователей, не обращайте внимания на это сообщение. Если у вас есть приложение корпоративного портала для конечных пользователей, с 30 апреля кнопка **Отправить отзыв** в приложении не будет работать в следующих сценариях:  
- Приложение корпоративного портала Windows 10, используемое в выпусках Windows 10 1507 и 1511  
- Приложение корпоративного портала Windows Phone 8.1  

Для указанных устройств функция **Отправить отзыв** завершится сбоем и не выполнит никаких действий даже в случае повторного использования. Чтобы отправить в корпорацию Майкрософт отзыв об этих платформах, вы можете воспользоваться приведенными ниже альтернативными каналами.  

#### <a name="what-do-i-need-to-do-to-prepare-for-this-change"></a>Как можно подготовиться к этому изменению?  
Сообщите пользователям об этом изменении и при необходимости обновите соответствующие инструкции. Проинформируйте конечных пользователей корпоративного портала в ОС Windows Phone 8.1, Windows 10 1507 и Windows 10 версии 1511 о том, что они могут использовать для предоставления отзывов два альтернативных канала. Доступные варианты:  
- Использовать приложение концентратора обратной связи для Windows 10
- Отправить сообщение электронной почты по адресу WinCPfeedback@microsoft.com  

Попросите конечных пользователей с ОС Windows 10 RS1 или более поздней выполнить обновление до последней версии корпоративного портала, которая доступна в Магазине.

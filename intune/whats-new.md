...
Сведения об обновленном разделе справки см. в статьях [Отправка журналов по электронной почте](/intune-user-help/send-logs-to-your-it-admin-by-email-android.md) и [Отправка сведений об ошибках в корпорацию Майкрософт](/intune-user-help/send-logs-to-microsoft-android.md).
...
На портале Azure в службе Microsoft Intune будет временно происходить перенаправление из колонки службы **Защита приложений Intune** в колонку **Мобильное приложение**. Имейте в виду, что все политики защиты приложений уже доступны в колонке **Мобильное приложение** в Intune в разделе настройки приложений. Вместо перехода к колонке "Защита приложений Intune" можно просто переходить в Intune. В апреле 2018 г. мы прекратим поддержку перенаправления и полностью удалим колонку службы **Защита приложений Intune**. Таким образом, политики защиты приложений в Intune будут находиться только в одном расположении. 

**Как это повлияет на работу?**
Это изменение затронет клиентов как автономного решения Intune, так и гибридного решения (Intune с Configuration Manager). Интеграция упростит управление облачной средой.

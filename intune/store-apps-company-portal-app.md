...
Если нужно загрузить неопубликованное приложение и вы подписали и назначили корпоративный портал для Windows 8.1 с помощью сертификата подписывания кода Symantec, выполните приведенные ниже шаги.  

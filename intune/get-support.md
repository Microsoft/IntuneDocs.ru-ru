---
title: Получение поддержки для Microsoft Intune | Microsoft Intune
...
Войдя на портал Azure и открыв Intune, вы можете выбрать пункт **Справка и поддержка** в любой колонке Intune, чтобы просмотреть решения распространенных проблем, связанных с данной областью Intune.

Если стандартные решения не помогают, вы можете выбрать пункт **запрос в службу поддержки**, чтобы создать запрос в службу поддержки. В результате открывается вкладка **Основные сведения** на странице *Справка и поддержка* Azure. Чтобы создать обращение в службу поддержки, перейдите к *шагу 3* следующей процедуры ([Создание запроса в службу поддержки в Интернете](#create-an-online-support-ticket)).
...
3. На вкладке **Основные сведения** выберите для большинства вопросов по технической поддержке Intune следующие параметры:
   ...
   - **Тема**: кратко опишите проблему, которая возникла.
...
![Изображение: область результатов просмотра решений](./media/get-support/view-results.png)
...
- Для запроса по электронной почте укажите свой адрес электронной почты и добавьте вложения при необходимости. Выберите **Отправить**, чтобы создать запрос.  
  ...
  ![Изображение: область запроса адреса электронной почты](./media/get-support/email-support.png)
...
- Для запроса по телефону укажите свой номер телефона. Также вы можете указать свой адрес электронной почты и добавить вложения. Выберите "Позвоните мне" для отправки запроса.  
   ...
   ![Изображение: область запроса номера телефона](./media/get-support/phone-support.png)
...
![Изображение: область просмотра запросов на поддержку](./media/get-support/view-support-tickets.png)

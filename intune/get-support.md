...
Новый интерфейс похож на интерфейс в [центре администрирования Microsoft 365](https://portal.office.com/AdminPortal/Home) и заменяет предыдущий [интерфейс справки и поддержки](#azure-help-+-support-experience). 

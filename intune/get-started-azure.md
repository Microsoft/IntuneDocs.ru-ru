...
При открытии Intune или любой другой службы в Azure она отображается на **панели**. Некоторые первые рабочие нагрузки, используемые в Intune, например **Пользователи**, **Группы** и **Клиентские приложения**, отображаются на панели в полноэкранном режиме. Выбранная рабочая нагрузка открывает эту панель во всю страницу. Другие открываемые панели разворачиваются из правой части панели и сворачиваются под главную панель, из которой они появились.

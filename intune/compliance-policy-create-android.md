...
> [!NOTE]
> Чтобы настроить параметры защиты Google Play с помощью политик защиты приложений, см. в статье [Параметры политики защиты приложений Intune](app-protection-policy-settings-android.md#conditional-launch) раздел для Android.

...
При запуске приложения "Корпоративный портал" в iOS пользователи могут получить сообщение, что устройство потеряло связь с Intune. В этом случае оно автоматически попытается синхронизироватся с Intune для восстановления подключения (появится уведомление **Выполняется попытка синхронизации…**). .
...
**Сообщение об ошибке 1**. *Похоже, вы используете виртуальную машину. Убедитесь, что вы полностью настроили виртуальную машину, включая серийный номер и модель оборудования. Если это не виртуальная машина, обратитесь в службу поддержки.*  

**Сообщение об ошибке 2**. *Не удается настроить управление для вашего устройства. Возможно, вы используете виртуальную машину, ограниченный серийный номер или это устройство уже назначено другому пользователю. Узнайте, как устранить эти проблемы, или обратитесь в службу поддержки своей компании.*

**Проблема**. Появление этого сообщения может быть вызвано любой из следующих причин.  
...
**Решение**. Сначала свяжитесь с пользователем, чтобы определить, какая именно проблема затрагивает его устройство. Затем выполните подходящее решение.

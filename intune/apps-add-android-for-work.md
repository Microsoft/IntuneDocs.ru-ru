...
ms.locfileid: "54239580"
---
# <a name="assign-managed-google-play-apps-to-android-enterprise-devices-with-intune"></a>Назначение управляемых приложений Google Play для корпоративных устройств с Android через Intune

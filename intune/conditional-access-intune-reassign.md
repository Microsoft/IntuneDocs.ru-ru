...
4. В разделе **Назначения** выберите **Пользователи и группы**, чтобы задать ориентацию для новой политики условного доступа.
    ...
    ![Сравнение пользовательского интерфейса группы пользователей на порталах Intune и Azure](./media/reassign-ca-1.png)
...
12. Выбрав их, дважды нажмите кнопку **Готово**.
    ...
    ![Сравнение пользовательского интерфейса платформы устройств на порталах Intune и Azure](./media/reassign-ca-4.png)
...
15. Выбрав его, дважды нажмите кнопку **Готово**.
    ...
    ![Сравнение пользовательского интерфейса клиентских приложений на порталах Intune и Azure](./media/reassign-ca-6.png)
...
21. В колонке политики условного доступа **Создать** установите переключатель **Включить политику**, а затем нажмите кнопку **Создать**.
    ...
    ![Сравнение пользовательского интерфейса включения политики условного доступа на порталах Intune и Azure](./media/reassign-ca-11.png)
...
4. В разделе **Назначения** выберите **Пользователи и группы**, чтобы задать ориентацию для новой политики условного доступа.
    ...
    ![Сравнение пользовательского интерфейса группы пользователей на порталах Intune и Azure](./media/reassign-ca-12.png)
...
7. В колонке **Облачные приложения** щелкните **Выбрать приложения** и выберите **Exchange Online**. Затем нажмите кнопки **Выбрать** и **Готово**.
    ...
    ![Сравнение пользовательского интерфейса облачных приложений на порталах Intune и Azure](./media/reassign-ca-14.png)
...
8. В колонке **Условия** выберите **Клиентские приложения**, а затем укажите подходящее клиентское приложение. Если вы решили блокировать клиенты, не поддерживаемые Intune, используйте параметр **Применить политику только к поддерживаемым платформам**.
    ...
    ![Сравнение пользовательского интерфейса клиентских приложений на порталах Intune и Azure](./media/reassign-ca-15.png)
...
11. В разделе **Grant Access Controls** (Предоставление элементов управления доступом) выберите **Требовать, чтобы устройство было отмечено как соответствующее**, а затем нажмите кнопку **Выбрать**.
    ...
    ![Сравнение пользовательского интерфейса предоставления доступа на порталах Intune и Azure](./media/reassign-ca-16.png)

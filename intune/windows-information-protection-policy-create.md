...
4. В колонке **Мобильные приложения** выберите **Политики защиты приложений**.
5. Щелкните **Add a policy** (Добавить политику), чтобы отобразилась колонка **Add a policy** (Добавление политики).
...
2. В колонке **Мобильные приложения** выберите **Политики защиты приложений**.

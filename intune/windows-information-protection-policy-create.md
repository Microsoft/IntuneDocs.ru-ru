...
2.  В колонке **Разрешенные приложения** щелкните **Добавить приложения**. На странице **Добавить приложения** отображаются все приложения, включенные в этот список.
...
3.  В колонке **Добавить приложения** в раскрывающемся списке выберите вариант **Приложения из Магазина**. Вид страницы изменится, и появятся поля, в которых необходимо указать **издателя** и **имя** приложения.

...
titlesuffix: ''
description: Узнайте, как добавлять приложения Win32 в Microsoft Intune и управлять ими.
keywords: ''
author: Erikre
ms.author: erikre
manager: dougeby
...
Изолированная среда Intune предоставляет больше возможностей управления приложениями Win32. Хотя клиенты, подключенные к облаку, могут использовать Configuration Manager для управления приложениями Win32, пользователи только Intune будут иметь больше возможностей управления своими бизнес-приложениями Win32. В этом документе содержатся обзор функции управления приложениями Win32 Intune и сведения об устранении неполадок.
...
- Вошел ли пользователь AAD в систему на клиентском компьютере?

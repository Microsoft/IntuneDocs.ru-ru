---
title: Добавление приложений Win32 в Microsoft Intune titlesuffix: description: Сведения о добавлении, доставке и управлении приложениями Win32 с помощью Microsoft Intune. В этой статье описано, как выполнять доставку и администрирование приложений Intune Win32, а также представлены сведения об устранении неполадок приложений Win32. keywords: author: Erikre ms.author: erikre manager: dougeby <<<<<<< HEAD ms.date: 10/23/2018 ======= ms.date: 10/19/2018

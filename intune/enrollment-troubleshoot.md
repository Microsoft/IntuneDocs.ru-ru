...
description: "Сведения об устранении проблем при регистрации устройства.\""
keywords: 
author: nathbarn
ms.author: nathbarn
manager: angrobe
...
1. Попробуйте зарегистрироваться еще раз.
    ...
    > Дополнительные сведения об архивации и восстановлении реестра см. в статье [Как сделать резервное копирование и восстановление реестра Windows](https://support.microsoft.com/kb/322756).

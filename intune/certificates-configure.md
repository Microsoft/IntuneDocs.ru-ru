...
4. В списке **Платформа** выберите платформу устройств для этого доверенного сертификата: 
...
5. В списке **Тип профиля** выберите **Доверенный сертификат**. Найдите сертификат (*CertificateName*.cer), сохраненный в шаге 2.
...
6. Нажмите **ОК**, чтобы сохранить изменения, и нажмите **Создать**, чтобы сохранить новый профиль.

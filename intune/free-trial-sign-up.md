...
- Центр администрирования Microsoft 365 ([admin.microsoft.com](https://admin.microsoft.com)) позволяет вам добавлять и контролировать пользователей, если для этого не применяется Azure Active Directory. Здесь также можно управлять и другими функциями учетной записи, включая выставление счетов и предоставление поддержки.

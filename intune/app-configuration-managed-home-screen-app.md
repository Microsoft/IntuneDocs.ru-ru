...
Чтобы открыть экран отладки Managed Home Screen, нажимайте кнопку **Назад**, пока не отобразится экран отладки (кнопку **Назад** нужно нажать 15 или более раз). На этом экране отладки можно запустить приложение политики устройств Android, просмотреть и отправить журналы или временно приостановить режим киоска для обновления устройства. См. подробнее о приостановке полноэкранного режима в описании параметра **Выйти из режима киоска** в разделе [Параметры выделенного устройства](device-restrictions-android-for-work.md#dedicated-device-settings) Android для бизнеса.

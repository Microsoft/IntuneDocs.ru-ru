...
Если вы хотите изменить профиль на менее безопасный, то в зависимости от платформы устройства может потребоваться сброс политик безопасности. Например, на рабочем столе Windows проведите пальцем от правого края и нажмите **Параметры** > **Панель управления**. Выберите приложение **Учетные записи пользователей** .

В нижней части левого меню навигации находится ссылка **Сбросить политики безопасности**. Нажмите на нее и выберите **Сбросить политики**. Чтобы применить менее строгий профиль для других устройств MDM (например, Android, Windows Phone 8.1 и более поздних версий, а также iOS), вам, возможно, потребуется снять устройство с учета и повторно зарегистрировать его в службе.

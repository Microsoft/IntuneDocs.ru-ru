...
> 
> Дополнительные сведения см. в статье [планирование Intune для изменения: приближается к завершению поддержки для Windows 7](../fundamentals/whats-new.md#intune-plan-for-change-nearing-end-of-support-for-windows-7-).

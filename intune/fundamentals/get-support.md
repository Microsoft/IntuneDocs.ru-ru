...
Справка и поддержка для Intune доступна из [Центра администрирования диспетчера конечных точек (Майкрософт)](https://go.microsoft.com/fwlink/?linkid=2109431) и из всех колонок (или страниц) в Intune на портале Azure.
...
- **Из Центра администрирования диспетчера конечных точек (Майкрософт)** :
  - Выбрав область функций для Intune, выберите пункт **Справка и поддержка**.
  - В любом узле Центра администрирования диспетчера конечных точек (Майкрософт) выберите значок **?** в правом верхнем углу, а затем в раскрывающемся списке выберите службу, для которой требуется помощь. Значок **?** в Центре администрирования диспетчера конечных точек (Майкрософт) поддерживает несколько служб. Вам нужно выбрать конкретную службу, для которой вам требуется помощь.  

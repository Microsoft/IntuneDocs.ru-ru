...
- [Настройка автоматической регистрации](../enrollment/quickstart-setup-auto-enrollment.md). Настройка Intune для автоматической регистрации устройств при входе конкретных пользователей на устройства Windows 10.
- [Регистрация устройства](../enrollment/quickstart-enroll-windows-device.md). Возьмите на себя роль пользователя Intune и зарегистрируйте свое устройство в Intune. Затем вернитесь в Intune и подтвердите успешную регистрацию устройства.
- [Создание политики соответствия устройств](../protect/quickstart-set-password-length-android.md). Создание политики соответствия требованиям для устройства и назначение группы этой политике.
- [Отправка уведомлений на несоответствующие устройства](../protect/quickstart-send-notification.md). Отправка уведомления по электронной почте сотрудникам с несоответствующими устройствами путем создания и назначения политики соответствия требованиям.
- [Добавление и назначение приложения](../apps/quickstart-add-assign-app.md). Добавление и назначение клиентского приложения сотрудникам вашей компании.
- [Создание и назначение политики защиты приложений](../apps/quickstart-create-assign-app-policy.md). Создание и назначение политики защиты приложений для клиентского приложения на устройстве конечного пользователя.
- [Создание и назначение пользовательской роли](create-custom-role.md). Создание и назначение пользовательской роли с определенными разрешениями для отдела безопасности. 
- [Создание профиля электронной почты для устройств iOS](../configuration/quickstart-email-profile.md). Создание профиля электронной почты для устройств iOS.
...
![Высокоуровневая архитектурная схема для Microsoft Intune](./media/get-started-evaluation/intunearchitecture.svg)

## <a name="next-steps"></a>Дальнейшие шаги

[Начало работы с Azure](tutorial-walkthrough-intune-portal.md). Общие сведения о структуре портала Azure и о том, как вносить изменения в отображаемую страницу.

## <a name="learn-more"></a>Дополнительные сведения

- [Что такое Intune?](what-is-intune.md)
- [Что представляет собой портал Azure?](what-is-intune.md)
- [Жизненные циклы устройств и приложений](device-lifecycle.md)

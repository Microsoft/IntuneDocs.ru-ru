...
- [Отправка ошибок, связанных с регистрацией устройств iOS или iPadOS, ИТ-администратору](/intune-user-help/send-errors-to-your-it-admin-ios)

...
Дополнительные сведения о Intune см. в статье [что такое Intune](what-is-intune.md).
...
- Управление обновлениями программного обеспечения
  ...
  - [Управление обновлениями iOS](../protect/software-updates-ios.md)  

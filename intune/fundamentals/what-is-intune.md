...
* [Условный доступ для приложения — разрешение доступа, если мобильное приложение содержит корпоративные данные](../protect/app-based-conditional-access-intune.md)
* [Изоляция корпоративных данных от личных данных внутри одного приложения](../apps/app-protection-policy.md)
* [Политика защиты приложения (ПИН-код, шифрование, элемент "сохранить как", буфер обмена и т. д.)](../apps/app-protection-policies.md)
* [Очистка корпоративных данных из мобильного приложения](../apps/apps-selective-wipe.md)
...
Краткое руководство по настройке работы с порталом см.в статье [Начало работы с Intune на портале Azure](tutorial-walkthrough-intune-portal.md).

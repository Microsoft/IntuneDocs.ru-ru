...
1. [Создание политики защиты приложений](../apps/app-protection-policies.md#create-an-app-protection-policy)
2. [Развертывание политики](../apps/app-protection-policies.md#deploy-a-policy-to-users)

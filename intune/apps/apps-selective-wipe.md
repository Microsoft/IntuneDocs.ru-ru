...
3. Щелкните **Выбрать пользователя**, выберите пользователя, чьи данные приложения нужно очистить, и нажмите кнопку **Выбрать** в нижней части области **Пользователь**.

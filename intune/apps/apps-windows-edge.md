...
2. На панели **Параметры приложения** выберите либо **Бета-версия**, либо **Dev** (Для разработчиков) в списке **Канал**, чтобы определить, из какого канала Edge вы развернете приложение.

...
5. На панели **Создать токен VPP** укажите следующие сведения:
    ...
    - **Автоматическое обновление приложений** — выберите **Вкл.** , чтобы включить автоматическое обновление, или **Выкл.** , чтобы отключить его. Если этот параметр включен, Intune обнаружит обновления приложений VPP в App Store и автоматически отправит их на устройство при его возврате. Автоматические обновления приложений Apple VPP изменяют только приложения, развернутые с использованием параметра установки **Обязательные**. Приложения, развернутые с помощью параметра установки **Доступные**, не будут отображаться на Корпоративном портале как установленные, даже если установлены его более ранние версии. В этом случае пользователь может переустановить приложение, нажав кнопку **Установить** на экране сведений в приложении Корпоративного портала, чтобы установить более новую версию приложения. Обратите внимание, что для зарегистрированных пользователями устройств с iOS пользователи будут по-прежнему видеть все приложения VPP с пользовательским лицензированием на Корпоративном портале. 
...
Intune синхронизирует токены и лицензии VPP с Apple дважды в день. Администратор Intune может запустить синхронизацию вручную в разделе **Приложения** > **Токены Apple VPP**.

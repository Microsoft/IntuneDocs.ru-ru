...
3. Выберите **Связанное приложение**. Выберите приложение Android, с которым будет связана эта политика конфигурации приложения. Для выбора используйте [список приложений в управляемом Google Play, которые были утверждены и синхронизированы в Intune](~/apps/apps-add-android-for-work.md).

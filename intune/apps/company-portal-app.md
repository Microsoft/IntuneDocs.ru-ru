...
Путем настройки Корпоративного портала можно обеспечить удобную и привычную среду для пользователей. Для этого на портале Intune выберите **Приложения** > **Фирменная символика и настройка**, а затем настройте необходимые параметры.

...
### <a name="add-additional-app-settings-to-a-managed-google-play-store-app"></a>Добавление дополнительных параметров приложения в приложение магазина в управляемом Google Play
1. Если необходимо добавить дополнительные сведения о приложении, выберите его в списке приложений.
2. Щелкните **Свойства** > **Изменить** рядом с параметром **Сведения о приложении**. Отобразится страница **Сведения о приложении**.
3. На странице **Сведения о приложении** добавьте сведения о приложении:
...
4. Щелкните **Проверить и сохранить**, чтобы просмотреть страницу **Проверка и сохранение**. 
5. По завершении нажмите кнопку **Сохранить**, чтобы обновить приложение в Intune.

...
3. В раскрывающемся списке **Тип приложения** выберите **Управляемый Google Play**.
4. Выберите **"Открыть" в разделе "Управляемый Google Play"** , чтобы открыть каталог управляемого Google Play.
5. Щелкните **Search Play Store** (Поиск по Google Play) в каталоге Google Play.
6. Введите в поле поиска название приложения, которым вы хотите управлять.
7. Выберите **Утвердить**, чтобы утвердить приложение в управляемом магазине Google Play, и щелкните **Утвердить**, чтобы принять разрешения приложения.
8. Выберите параметр **Keep approved when app requests new permissions** (Сохранить утверждение при запросе приложением новых разрешений) в окне параметров утверждения, а затем нажмите кнопку **Сохранить**. Если вы не выберете этот параметр, потребуется вручную утверждать все новые разрешения, когда разработчик приложения будет публиковать обновления. В результате установка и обновление приложения будут останавливаться до утверждения разрешений. Поэтому рекомендуем выбрать параметр автоматического утверждения новых разрешений. 
9. Щелкните **ОК**, чтобы включить приложения, которые вы утвердили.
...
3. В раскрывающемся списке **Тип приложения** выберите **Управляемый Google Play**.
4. Выберите **"Открыть" в разделе "Управляемый Google Play"** , чтобы открыть каталог управляемого Google Play.
5. Выберите **Веб-приложения** в каталоге Google Play.
6. Нажмите кнопку **+** , чтобы добавить приложение.
7. Введите нужную информацию, а затем щелкните **Создать**.
8. Закройте панель управляемого Google Play, если вы завершили добавление приложений.
9. Щелкните **Синхронизировать** на панели **Приложение** для синхронизации со службой управляемого магазина Google Play. Обратите внимание, что может пройти несколько минут, пока частное приложение станет доступным для синхронизации. Если при первом выполнении синхронизации вы его не увидите, подождите несколько минут и попробуйте повторить синхронизацию.

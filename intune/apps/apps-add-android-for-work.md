...
7. Выберите **"Открыть" в разделе "Управляемый Google Play"** , чтобы открыть каталог управляемого Google Play.
7. Щелкните **Search Play Store** (Поиск по Google Play) в каталоге Google Play.
8. Введите в поле поиска название приложения, которым вы хотите управлять.
...
6. В раскрывающемся списке **Тип приложения** выберите **Управляемый Google Play**.
7. Выберите **"Открыть" в разделе "Управляемый Google Play"** , чтобы открыть каталог управляемого Google Play.
7. Выберите **Частные приложения** в каталоге Google Play.
7. Нажмите кнопку **+** , чтобы добавить приложение.
8. Отправьте заголовок и пакет APK для этого приложения.
9. Нажмите кнопку **Создать**.
9. Закройте панель управляемого Google Play, если вы завершили добавление приложений.
12. Щелкните **Синхронизировать** на панели **Приложение** для синхронизации со службой управляемого магазина Google Play. Обратите внимание, что может пройти несколько минут, пока частное приложение станет доступным для синхронизации. Если при первом выполнении синхронизации вы его не увидите, подождите несколько минут и попробуйте повторить синхронизацию.
...
6. В раскрывающемся списке **Тип приложения** выберите **Управляемый Google Play**.
7. Выберите **"Открыть" в разделе "Управляемый Google Play"** , чтобы открыть каталог управляемого Google Play.
7. Выберите **Веб-приложения** в каталоге Google Play.
7. Нажмите кнопку **+** , чтобы добавить приложение.
7. Введите нужную информацию, а затем щелкните **Создать**.
7. Закройте панель управляемого Google Play, если вы завершили добавление приложений.
12. Щелкните **Синхронизировать** на панели **Приложение** для синхронизации со службой управляемого магазина Google Play. Обратите внимание, что может пройти несколько минут, пока частное приложение станет доступным для синхронизации. Если при первом выполнении синхронизации вы его не увидите, подождите несколько минут и попробуйте повторить синхронизацию.
...
Если вы утвердили приложение из магазина, но оно отсутствует в рабочей нагрузке **Клиентские приложения**, принудительно выполните немедленную синхронизацию следующим образом.

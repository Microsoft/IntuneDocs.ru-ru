...
4. Щелкните **Select the public app** (Выберите общедоступное приложение) и выберите **Managed Browser** и/или **Edge** для iOS, Android или для обеих платформ одновременно.

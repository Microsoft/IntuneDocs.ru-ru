...
## <a name="disable-microsoft-edge-prompt-to-save-passwords"></a>Отключение запроса на сохранение паролей в Microsoft Edge
...
|    Key    |    Значение    |
|-----------|-------------|
|     "com.microsoft.intune.mam.managedbrowser.disableFeatures"    |    Значение **password** отключает отображение запроса на сохранение паролей.    |

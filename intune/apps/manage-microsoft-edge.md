...
|    Key    |    Значение    |
|------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
|    com.microsoft.intune.SohwIndustryNews    |    Если указать значение **True**, отраслевые новости будут отображаться на новой вкладке мобильного браузера Microsoft Edge.<p>Если указать значение **False** (по умолчанию), отраслевые новости будут скрыты на новой вкладке.    |

...
3. В области **Добавление приложений** найдите список **Тип приложения** в разделе **Пакет Office 365** и выберите **Windows 10**.
...
При выборе значения **Конструктор конфигурации** на панели **Добавление приложения** появятся два дополнительных параметра:
- Настройка набора приложений
- Параметры набора приложений

<img alt="Add Office 365 - Configuration designer" src="./media/apps-add-office365/apps-add-office365-02.png" width="700">

Если выбрать **Введите данные XML**, на панели **Добавление приложения** появится параметр **Введите данные XML**. Выберите его, чтобы открыть панель **Файл конфигурации**. 
...
Если в раскрывающемся списке **Setting format** (Формат параметров) вы выбрали **Конструктор конфигурации**, на панели **Добавление приложения** появится параметр **Настроить набор приложений**. Выберите приложения Office, которые вы хотите назначить устройствам.
...
## <a name="configure-app-suite-settings"></a>Настройка параметров набора приложений

Если в раскрывающемся списке **Setting format** (Формат параметров) вы выбрали **Конструктор конфигурации**, на панели **Добавление приложения** появится параметр **Параметры набора приложений**. Настройте на этом шаге параметры установки для набора приложений. Эти параметры применяются ко всем приложениям, добавленным в набор.
...
Если в раскрывающемся списке **Setting format** (Формат параметров) вы выбрали **Введите данные XML**, на панели **Добавление приложения** появится параметр **Введите данные XML**. Дополнительные сведения см. в статье [Параметры конфигурации для средства развертывания Office](https://docs.microsoft.com/DeployOffice/configuration-options-for-the-office-2016-deployment-tool).
...
Сведения о том, как просматривать журналы установки, см. в статье о [включении ведения журнала для Office 365 профессиональный плюс в ULS](https://blogs.technet.microsoft.com/odsupport/2018/06/18/how-to-enable-office-365-proplus-uls-logging).

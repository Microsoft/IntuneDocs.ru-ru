...
4. В списке **Платформа** выберите **iOS**.
5. Выберите **Связанное приложение**. Затем на панели **Связанное приложение** выберите управляемое приложение, к которому следует применить конфигурацию, и нажмите **OK**.
6. Выберите **Параметры конфигурации**, чтобы отобразить панель **Параметры конфигурации**.
7. Выберите **Формат параметров конфигурации**. Выберите один из следующих методов, чтобы добавить сведения о конфигурации:
...
8. После добавления сведений о конфигурации нажмите кнопку **ОК**, а затем выберите **Добавить**, чтобы добавить политику конфигурации. Откроется панель с общими сведениями о политике конфигурации.
9. Выберите **Назначения**, чтобы просмотреть варианты включения и исключения. 
...
10. Выберите **Все пользователи** на вкладке **Включить**.
...
11. Перейдите на вкладку **Исключить**. 

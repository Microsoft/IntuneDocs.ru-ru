...
> [!NOTE]
> Сведения о коде ошибки установки конкретного приложения см. в [справочнике по ошибкам установки приложений Intune](~/apps/app-install-error-codes.md).

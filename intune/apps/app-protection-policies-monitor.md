...
после появления данных **отчета о пользователях (защита приложений)** , вы сможете сводить их по следующим параметрам.
...
- **Имя приложения**. Данные сгруппированы по фактическому имени приложения. Опять же, состояние может быть "Сбой", "Предупреждение" или "Успешно".

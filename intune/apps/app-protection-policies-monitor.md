...
- **Ведущие защищенные приложения для iOS** и **ведущие защищенные приложения для Android**. Исходя из наиболее часто используемых приложений для iOS и Android, здесь показано число защищенных и незащищенных приложений для каждой платформы.
- **Ведущие настроенные приложения для iOS без регистрации** и **ведущие настроенные приложения для Android без регистрации**. Исходя из наиболее часто используемых приложений для iOS и Android для незарегистрированных устройств, здесь показано число настроенных приложений для каждой платформы (как при использовании политики конфигурации приложений).

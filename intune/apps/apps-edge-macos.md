...
2. В колонке **Параметры приложения** канал **бета-версий** выбирается автоматически и не может быть изменен.
...
После настройки выберите **Добавить** в колонке **Приложения**. 

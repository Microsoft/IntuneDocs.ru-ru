...
4. На странице **Основные** добавьте следующие значения.
    ...
    ![Снимок экрана: страница"Общие сведения" панели "Создание политики"](~/apps/media/app-protection-policies/app-protection-add-policies-01.png)
...
6. Нажмите кнопку **Далее**, чтобы открыть страницу **Защита данных**.<br>
    ...
    **Параметры защиты данных**.<br>
    - **Защита данных на iOS/iPadOS**. Дополнительные сведения см. в разделе [Параметры политики защиты приложений для iOS/iPadOS — защита данных](~/apps/app-protection-policy-settings-ios.md#data-protection).
...
7. Нажмите кнопку **Далее**, чтобы перейти к странице **Требования к доступу**.<br>
    ...
    **Параметры требований для доступа**.<br>
    - **Требования для доступа на iOS/iPadOS**. Дополнительные сведения см. в разделе [Параметры политики защиты приложений для iOS/iPadOS — требования к доступу](~/apps/app-protection-policy-settings-ios.md#access-requirements).
...
8. Нажмите кнопку **Далее**, чтобы отобразить страницу **Условный запуск**.<br>
    ...
    **Параметры условного запуска**.<br>
    - **Параметры условного запуска на iOS/iPadOS**. Дополнительные сведения см. в разделе [Параметры политики защиты приложений для iOS/iPadOS — условный запуск](~/apps/app-protection-policy-settings-ios.md#conditional-launch).

...
1. В [Intune](https://aka.ms/intuneportal) выберите **Регистрация устройства** > **Регистрация Windows** > **Соединитель Intune для Active Directory (предварительная версия)**  > **Добавить соединитель**. 
...
7. Откройте раздел **Регистрация устройства** > **Регистрация Windows** > **Соединитель Intune для Active Directory (предварительная версия)** и убедитесь в том, что подключение находится в состоянии **Активно**.

...
5. [Возможно, потребуется создать дополнительные записи DNS для регистраций Intune](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium).
...
Вы можете узнать о том, как [упростить регистрацию Windows без Azure AD Premium](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium), создав запись DNS CNAME, которая перенаправляет регистрацию на серверы Intune.

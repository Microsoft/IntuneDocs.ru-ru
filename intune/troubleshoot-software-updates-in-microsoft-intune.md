...
Помощь в устранении проблем с обновлениями программного обеспечения в Microsoft Intune.
...
В следующей таблице перечислены коды ошибок **агента обновления** Intune. Если какой-либо код ошибки отсутствует в этой таблице, см. статью [Список кодов ошибок Центра обновления Windows](https://support.microsoft.com/help/938205/windows-update-error-code-list).
...
**Решение**.  
1. Войдите на [портал Azure](https://portal.azure.com) и откройте **Microsoft Intune**. 

...
3. Выберите **Устройства** > **Все устройства**, а затем одно из перечисленных устройств, чтобы открыть сведения о нем.
   ...
   - В разделе **Обнаруженные приложения** отображается список установленных на устройстве приложений, найденных с помощью Intune. Список приложений можно **экспортировать** в CSV-файл. Этот список обновляется каждые 7 дней.
...
|Android для бизнеса|Только управляемые приложения|Только приложения, установленные в рабочем профиле|  

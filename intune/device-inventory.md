...
3. Выберите **Устройства** > **Все устройства**, а затем одно из перечисленных устройств, чтобы открыть сведения о нем.
   ...
   - В разделе **Обзор** отображается имя устройства и содержатся некоторые основные свойства, например зарегистрировано ли устройство в программе "Принеси свое устройство" (BYOD), когда именно оно зарегистрировано, а также многое другое. При выборе **Дополнительно** доступны следующие функции.

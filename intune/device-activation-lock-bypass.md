...
5. Выберите нужное защищенное устройство iOS в списке управляемых устройств, нажмите **...Еще** и выберите удаленное действие **Обход блокировки активации**.

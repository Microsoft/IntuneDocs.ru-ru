...
- Устройства должны быть присоединены к службе Azure AD или зарегистрированы в ней, а в Azure AD должна быть настроена [автоматическая регистрация в Intune](windows-enroll.md#enable-windows-10-automatic-enrollment). Расширение управления Intune поддерживает устройства Windows, зарегистрированные в AAD или гибридном домене, а также совместно управляемые устройства.
...
3. Введите **имя** и **описание** скрипта PowerShell. В поле **Расположение скрипта** укажите скрипт PowerShell. Размер скрипта не должен превышать 200 КБ.

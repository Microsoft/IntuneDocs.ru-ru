...
> [!NOTE]
> Скрипт PowerShell будет выполняться при наличии прав администратора (по умолчанию), если для скрипта настроен контекст пользователя, а пользователь устройства имеет права администратора.

...
- Приложение [Класс](https://itunes.apple.com/us/app/classroom/id1085319084?mt=8) необходимо установить на устройстве преподавателя. Это можно сделать вручную или используя возможности [управления приложениями Intune](app-management.md).

...
- **URL-адрес фонового изображения рабочего стола (только для настольных компьютеров)**. Указывает URL-адрес изображения в формате PNG, JPG или JPEG, используемого в качестве фонового рисунка рабочего стола Windows. Пользователи не могут изменить этот параметр.

...
-   **Режим терминала** — определяет тип [режима киоска](https://docs.microsoft.com/en-us/windows/configuration/kiosk-shared-pc), поддерживаемый этой политикой.  Возможны следующие значения.
    ...
    Конфигурации киоска с несколькими приложениями включают в себя следующее:
    ...
    - Одно или несколько **приложений киоска** со следующими параметрами:
        ...
        - **Тип приложения**, который указывает на тип приложения киоска.  Поддерживаемые значения.   
            ...
            - **Приложение Win32** — традиционное классическое приложение.  (Вам потребуется полный путь к исполняемому файлу по отношению к устройству.)

            - **Приложение UWP** — универсальное приложение для Windows.  Вам потребуется [AUMID приложения](https://docs.microsoft.com/en-us/windows-hardware/customize/enterprise/find-the-application-user-model-id-of-an-installed-app).

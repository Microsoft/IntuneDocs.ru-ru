...
- **Передача диагностических данных.** Возможные значения:
    ...
    - **Основные** — в Майкрософт отправляются ограниченные сведения.
...
- **URL-адрес изображения на экране блокировки (только для настольных компьютеров).** Указывает URL-адрес изображения в формате PNG, JPG или JPEG, используемого в качестве фонового изображения экрана блокировки Windows. Пользователи не могут изменить этот параметр.

...
-   **Персонализация ввода**. Позволяет отключить использование облачных служб речи для Кортаны, диктофона или приложений Магазина Windows. Если вы разрешите эти службы, корпорация Майкрософт может собирать голосовые данные для улучшения обслуживания.

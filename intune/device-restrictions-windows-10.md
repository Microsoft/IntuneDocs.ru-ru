...
-   **Раскрывающийся список адресной строки (только компьютеры)**. Позволяет запретить Microsoft Edge отображать предложения в виде раскрывающегося списка при вводе. Это помогает минимизировать использование пропускной способности сети между Microsoft Edge и службами Майкрософт.

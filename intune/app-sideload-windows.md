...
Первый шаг — это подписывание пакета APPX. Дополнительные сведения см. в статье [Sign an app package using SignTool](https://docs.microsoft.com/windows/uwp/packaging/sign-app-package-using-signtool) (Подписание пакета приложения с помощью SignTool).

## <a name="upload-your-app"></a>Отправка приложения

Затем нужно передать подписанный appx-файл, как описано в статье [Добавление бизнес-приложения Windows в Microsoft Intune](lob-apps-windows.md).

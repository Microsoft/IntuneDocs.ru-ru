---
title: "Создание политики соответствия устройств iOS в Microsoft Intune"
titleSuffix: 
description: "Создайте политику соответствия для устройств iOS в Microsoft Intune, чтобы указывать требования, которым должно соответствовать устройство."
keywords: 
author: msmimart
ms.author: mimart
manager: dougeby
...
3. Выберите **Требования соответствия**, чтобы указать значения параметров **Безопасность системы**, **Работоспособность устройства** и **Свойства устройства**. По завершении нажмите кнопку **ОК**.
